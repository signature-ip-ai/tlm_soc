...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_L3_RX_REQPROC__PI38_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_L3_RX_REQPROC__PI38_H_  // guard

#include "systemc"
#include "verilated_sc.h"
#include "verilated.h"
class Vsig_topology_top_sig_ic_crdt_update__N8;
class Vsig_topology_top_sig_l3_rx_reqproc_anyvc__pi51;


class Vsig_topology_top__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_l3_rx_reqproc__pi38 final : public VerilatedModule {
  public:
    // CELLS
    Vsig_topology_top_sig_l3_rx_reqproc_anyvc__pi51* __PVT__sig_l3_rx_reqproc_vc1;
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_l3_rx_reqproc__pi38(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_l3_rx_reqproc__pi38();
    VL_UNCOPYABLE(Vsig_topology_top_sig_l3_rx_reqproc__pi38);
