...
VL_ATTR_COLD void Vsig_topology_top_sig_double_synchronizer_param_dw__pi2___ctor_var_reset(Vsig_topology_top_sig_double_synchronizer_param_dw__pi2* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                          Vsig_topology_top_sig_double_synchronizer_param_dw__pi2___ctor_var_reset\n"); );
