...
VL_ATTR_COLD void Vsig_topology_top_sig_chi_rcv_reqproc__pi13___eval_initial__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_chi_cc_top_0__sig_chi_rcv_reqproc_0(Vsig_topology_top_sig_chi_rcv_reqproc__pi13* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vsig_topology_top_sig_chi_rcv_reqproc__pi13___eval_initial__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_chi_cc_top_0__sig_chi_rcv_reqproc_0\n"); );
...
VL_ATTR_COLD void Vsig_topology_top_sig_chi_rcv_reqproc__pi13___stl_comb__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_chi_cc_top_0__sig_chi_rcv_reqproc_0__0(Vsig_topology_top_sig_chi_rcv_reqproc__pi13* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vsig_topology_top_sig_chi_rcv_reqproc__pi13___stl_comb__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_chi_cc_top_0__sig_chi_rcv_reqproc_0__0\n"); );
    Vsig_topology_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
VL_ATTR_COLD void Vsig_topology_top_sig_chi_rcv_reqproc__pi13___ctor_var_reset(Vsig_topology_top_sig_chi_rcv_reqproc__pi13* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vsig_topology_top_sig_chi_rcv_reqproc__pi13___ctor_var_reset\n"); );
    Vsig_topology_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    vlSelf->__PVT__cm_flit_addr_sliced_pm = VL_SCOPED_RAND_RESET_Q(56, __VscopeHash, 5917875059357151425ull);
    ...
    vlSelf->__PVT__noncm_flit_addr_sliced_pm = VL_SCOPED_RAND_RESET_Q(56, __VscopeHash, 12410074179275294719ull);
    vlSelf->__PVT__noncm_addr_match_pm = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 448483759362002529ull);
