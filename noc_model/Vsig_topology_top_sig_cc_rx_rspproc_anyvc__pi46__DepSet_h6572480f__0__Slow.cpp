...
VL_ATTR_COLD void Vsig_topology_top_sig_cc_rx_rspproc_anyvc__pi46___eval_initial__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_cc_porttop_0__sig_cc_porttop_gen_blk__DOT__sig_cc_rxtop_0__sig_cc_rx_rspproc_0__sig_cc_rx_rspproc_vc0(Vsig_topology_top_sig_cc_rx_rspproc_anyvc__pi46* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vsig_topology_top_sig_cc_rx_rspproc_anyvc__pi46___eval_initial__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_cc_porttop_0__sig_cc_porttop_gen_blk__DOT__sig_cc_rxtop_0__sig_cc_rx_rspproc_0__sig_cc_rx_rspproc_vc0\n"); );
...
VL_ATTR_COLD void Vsig_topology_top_sig_cc_rx_rspproc_anyvc__pi46___eval_initial__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_cc_porttop_0__sig_cc_porttop_gen_blk__DOT__sig_cc_rxtop_0__sig_cc_rx_rspproc_0__sig_cc_rx_rspproc_vc1(Vsig_topology_top_sig_cc_rx_rspproc_anyvc__pi46* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vsig_topology_top_sig_cc_rx_rspproc_anyvc__pi46___eval_initial__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_cc_porttop_0__sig_cc_porttop_gen_blk__DOT__sig_cc_rxtop_0__sig_cc_rx_rspproc_0__sig_cc_rx_rspproc_vc1\n"); );
    Vsig_topology_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__my_topology_x = 0U;
...
VL_ATTR_COLD void Vsig_topology_top_sig_cc_rx_rspproc_anyvc__pi46___ctor_var_reset(Vsig_topology_top_sig_cc_rx_rspproc_anyvc__pi46* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vsig_topology_top_sig_cc_rx_rspproc_anyvc__pi46___ctor_var_reset\n"); );
    Vsig_topology_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    VL_SCOPED_RAND_RESET_W(73, vlSelf->__PVT__ic_RX_FLIT, __VscopeHash, 13586822630252626842ull);
    ...
    VL_SCOPED_RAND_RESET_W(73, vlSelf->__PVT__read_data_fifo, __VscopeHash, 15169263796891844761ull);
    ...
    VL_SCOPED_RAND_RESET_W(73, vlSelf->__PVT__flit_out_pl, __VscopeHash, 14866324993249643111ull);
    vlSelf->__PVT__flit_out_meta = VL_SCOPED_RAND_RESET_I(6, __VscopeHash, 4781678093268733927ull);
    VL_SCOPED_RAND_RESET_W(73, vlSelf->__PVT__read_data_fifo_stored, __VscopeHash, 18266271290246763668ull);
    VL_SCOPED_RAND_RESET_W(73, vlSelf->__PVT__read_data_fifo_stored_nxt, __VscopeHash, 9236714825484219837ull);
    ...
    VL_SCOPED_RAND_RESET_W(73, vlSelf->__PVT__ic_RX_FLIT_s, __VscopeHash, 6919022787034322246ull);
    VL_SCOPED_RAND_RESET_W(73, vlSelf->__PVT__read_data_fifo_s, __VscopeHash, 2154881700464928972ull);
    VL_SCOPED_RAND_RESET_W(73, vlSelf->__PVT__read_data_fifo_stored_s, __VscopeHash, 4216220924151580407ull);
    ...
    VL_SCOPED_RAND_RESET_W(73, vlSelf->__Vdly__read_data_fifo_stored, __VscopeHash, 2990092295006844582ull);
}
