...
#include "verilated.h"
class Vsig_topology_top_sig_cc_rx_rspproc_anyvc__pi46;
...
class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_cc_rx_rspproc__pi29 final : public VerilatedModule {
  public:
    // CELLS
    Vsig_topology_top_sig_cc_rx_rspproc_anyvc__pi46* __PVT__sig_cc_rx_rspproc_vc0;
    Vsig_topology_top_sig_cc_rx_rspproc_anyvc__pi46* __PVT__sig_cc_rx_rspproc_vc1;
