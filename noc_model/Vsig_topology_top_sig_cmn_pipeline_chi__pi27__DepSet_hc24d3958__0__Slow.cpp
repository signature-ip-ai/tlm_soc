...
VL_ATTR_COLD void Vsig_topology_top_sig_cmn_pipeline_chi__pi27___eval_initial__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_node_porttop_sn_p1__node_porttop_sn__DOT__u_sig_cmn_pipeline_sn(Vsig_topology_top_sig_cmn_pipeline_chi__pi27* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vsig_topology_top_sig_cmn_pipeline_chi__pi27___eval_initial__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_node_porttop_sn_p1__node_porttop_sn__DOT__u_sig_cmn_pipeline_sn\n"); );
    Vsig_topology_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__syscoack_slv = 0U;
    vlSelfRef.__PVT__syscoreq_mst = 0U;
    vlSelfRef.__PVT__rxreqflitpend_mst = 0U;
    vlSelfRef.__PVT__rxreqflitv_mst = 0U;
    VL_CONST_W_1X(151,vlSelfRef.__PVT__rxreqflit_mst,0x00000000);
    vlSelfRef.__PVT__rxreqlcrdv_slv = 0U;
    vlSelfRef.__PVT__txrspflitpend_slv = 0U;
    vlSelfRef.__PVT__txrspflitv_slv = 0U;
    VL_CONST_W_1X(73,vlSelfRef.__PVT__txrspflit_slv,0x00000000);
    vlSelfRef.__PVT__txrsplcrdv_mst = 0U;
}

VL_ATTR_COLD void Vsig_topology_top_sig_cmn_pipeline_chi__pi27___stl_sequent__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_node_porttop_sn_p1__node_porttop_sn__DOT__u_sig_cmn_pipeline_sn__0(Vsig_topology_top_sig_cmn_pipeline_chi__pi27* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vsig_topology_top_sig_cmn_pipeline_chi__pi27___stl_sequent__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_node_porttop_sn_p1__node_porttop_sn__DOT__u_sig_cmn_pipeline_sn__0\n"); );
    Vsig_topology_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vsig_topology_top_sig_cmn_pipeline_chi__pi27___eval_initial__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_node_porttop_sn_p0__node_porttop_sn__DOT__u_sig_cmn_pipeline_sn(Vsig_topology_top_sig_cmn_pipeline_chi__pi27* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vsig_topology_top_sig_cmn_pipeline_chi__pi27___eval_initial__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_node_porttop_sn_p0__node_porttop_sn__DOT__u_sig_cmn_pipeline_sn\n"); );
    Vsig_topology_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__syscoack_slv = 0U;
...
VL_ATTR_COLD void Vsig_topology_top_sig_cmn_pipeline_chi__pi27___stl_sequent__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_node_porttop_sn_p0__node_porttop_sn__DOT__u_sig_cmn_pipeline_sn__0(Vsig_topology_top_sig_cmn_pipeline_chi__pi27* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vsig_topology_top_sig_cmn_pipeline_chi__pi27___stl_sequent__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_node_porttop_sn_p0__node_porttop_sn__DOT__u_sig_cmn_pipeline_sn__0\n"); );
    Vsig_topology_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__nodeport_configuration__DOT__hn_to_sn_configuration__DOT__unused_signals_nxt 
...
VL_ATTR_COLD void Vsig_topology_top_sig_cmn_pipeline_chi__pi27___ctor_var_reset(Vsig_topology_top_sig_cmn_pipeline_chi__pi27* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vsig_topology_top_sig_cmn_pipeline_chi__pi27___ctor_var_reset\n"); );
    Vsig_topology_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    vlSelf->__PVT__txrspflit_slv[0] = 0U;
    vlSelf->__PVT__txrspflit_slv[1] = 0U;
    vlSelf->__PVT__txrspflit_slv[2] = 0U;
    ...
    VL_SCOPED_RAND_RESET_W(151, vlSelf->__PVT__txsnpflit_slv, __VscopeHash, 15941258563313580651ull);
    ...
    vlSelf->__PVT__rxreqflit_mst[0] = 0U;
    vlSelf->__PVT__rxreqflit_mst[1] = 0U;
    vlSelf->__PVT__rxreqflit_mst[2] = 0U;
    vlSelf->__PVT__rxreqflit_mst[3] = 0U;
    vlSelf->__PVT__rxreqflit_mst[4] = 0U;
    ...
    VL_SCOPED_RAND_RESET_W(151, vlSelf->__PVT__txsnpflit_mst, __VscopeHash, 15257352681662199064ull);
    ...
    VL_SCOPED_RAND_RESET_W(154, vlSelf->__Vcellout__i_pipe_rxsnp_mst__data_out, __VscopeHash, 13511185597559702030ull);
    VL_SCOPED_RAND_RESET_W(154, vlSelf->__Vcellinp__i_pipe_rxsnp_mst__data_in, __VscopeHash, 3788156576427918036ull);
    ...
    vlSelf->__PVT__nodeport_configuration__DOT__hn_to_sn_configuration__DOT__unused_signals = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 2458001493164306322ull);
    vlSelf->__PVT__nodeport_configuration__DOT__hn_to_sn_configuration__DOT__unused_signals_nxt = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 12233564286025351927ull);
    vlSelf->__Vdly__nodeport_configuration__DOT__hn_to_sn_configuration__DOT__unused_signals = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 2274198544948514634ull);
}
