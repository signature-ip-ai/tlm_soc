...
VL_ATTR_COLD void Vsig_topology_top_sig_l3_rx_datproc_anyvc__pi54___ctor_var_reset(Vsig_topology_top_sig_l3_rx_datproc_anyvc__pi54* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vsig_topology_top_sig_l3_rx_datproc_anyvc__pi54___ctor_var_reset\n"); );
    ...
    VL_SCOPED_RAND_RESET_W(680, vlSelf->__PVT__flit_out_pl, __VscopeHash, 14866324993249643111ull);
