...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_NODE_RX_DATPROC_ANYVC__PI65_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_NODE_RX_DATPROC_ANYVC__PI65_H_  // guard

#include "systemc"
#include "verilated_sc.h"
#include "verilated.h"
class Vsig_topology_top_sig_fifo_synchclk_flop__pi71;
class Vsig_topology_top_sig_routing_policy;


class Vsig_topology_top__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_node_rx_datproc_anyvc__pi65 final : public VerilatedModule {
  public:
    // CELLS
    Vsig_topology_top_sig_routing_policy* __PVT__inst_sig_routing_policy;
    Vsig_topology_top_sig_fifo_synchclk_flop__pi71* __PVT__sync_fifo_gen__DOT__flit_store_fifo_0;
    ...
    VL_OUT8(__PVT__o_rxtop_datproc_fifo_is_full,0,0);
    ...
    CData/*7:0*/ __PVT__tgt_clusterid;
    ...
    VlWide<22>/*679:0*/ __Vcellout__sync_fifo_gen__DOT__flit_store_fifo_0__fifo_rddata;
    VlWide<22>/*679:0*/ __Vcellinp__sync_fifo_gen__DOT__flit_store_fifo_0__fifo_wrdata;
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_node_rx_datproc_anyvc__pi65(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_node_rx_datproc_anyvc__pi65();
    VL_UNCOPYABLE(Vsig_topology_top_sig_node_rx_datproc_anyvc__pi65);
