...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_NODE_ARBTOP_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_NODE_ARBTOP_H_  // guard

#include "systemc"
#include "verilated_sc.h"
#include "verilated.h"
class Vsig_topology_top_sig_node_vcarb;
class Vsig_topology_top_sig_tx_portarb;


class Vsig_topology_top__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_node_arbtop final : public VerilatedModule {
  public:
    // CELLS
    Vsig_topology_top_sig_tx_portarb* __PVT__sig_tx_portarb_vc0;
    Vsig_topology_top_sig_tx_portarb* __PVT__sig_tx_portarb_vc1;
    Vsig_topology_top_sig_node_vcarb* __PVT__sig_node_vcarb_0;
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_node_arbtop(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_node_arbtop();
    VL_UNCOPYABLE(Vsig_topology_top_sig_node_arbtop);
