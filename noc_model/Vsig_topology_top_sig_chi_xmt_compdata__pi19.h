...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_CHI_XMT_COMPDATA__PI19_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_CHI_XMT_COMPDATA__PI19_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_chi_xmt_compdata__pi19 final : public VerilatedModule {
  public:
    // CELLS
    ...
    struct {
        ...
        VL_OUT8(__PVT__dat_link_crdt_atleast_2,0,0);
    ...
    struct {
        ...
        CData/*0:0*/ __PVT__dat_link_crdt_avlble;
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_chi_xmt_compdata__pi19(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_chi_xmt_compdata__pi19();
    VL_UNCOPYABLE(Vsig_topology_top_sig_chi_xmt_compdata__pi19);
