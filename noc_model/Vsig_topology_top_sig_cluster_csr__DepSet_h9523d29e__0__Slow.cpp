...
VL_ATTR_COLD void Vsig_topology_top_sig_cluster_csr___stl_sequent__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__inst_sig_cluster_csr__0(Vsig_topology_top_sig_cluster_csr* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vsig_topology_top_sig_cluster_csr___stl_sequent__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__inst_sig_cluster_csr__0\n"); );
    ...
    vlSelfRef.__PVT__i_rd_data_proc_port_reg_1 = VL_EXTEND_II(32,2, 
                                                              VL_CONCAT_III(2,1,1, (IData)(vlSelfRef.__PVT__i_proc_port_reg_1_tx_is_inactive), (IData)(vlSelfRef.__PVT__i_proc_port_reg_1_rx_is_inactive)));
    ...
    vlSymsp->TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__inst_sig_cluster_csr__rw_qos_override_reg.__PVT__i_wr_reg_en 
        = vlSelfRef.__Vcellinp__rw_qos_override_reg__i_wr_reg_en;
    vlSymsp->TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__inst_sig_cluster_csr__ro_proc_port_reg_1.__PVT__in_data 
        = vlSelfRef.__PVT__i_rd_data_proc_port_reg_1;
}

VL_ATTR_COLD void Vsig_topology_top_sig_cluster_csr___stl_sequent__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__inst_sig_cluster_csr__1(Vsig_topology_top_sig_cluster_csr* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vsig_topology_top_sig_cluster_csr___stl_sequent__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__inst_sig_cluster_csr__1\n"); );
    Vsig_topology_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vsig_topology_top_sig_cluster_csr___stl_sequent__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__inst_sig_cluster_csr__2(Vsig_topology_top_sig_cluster_csr* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vsig_topology_top_sig_cluster_csr___stl_sequent__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__inst_sig_cluster_csr__2\n"); );
    Vsig_topology_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vsig_topology_top_sig_cluster_csr___stl_sequent__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__inst_sig_cluster_csr__3(Vsig_topology_top_sig_cluster_csr* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vsig_topology_top_sig_cluster_csr___stl_sequent__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__inst_sig_cluster_csr__3\n"); );
    Vsig_topology_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vsig_topology_top_sig_cluster_csr___stl_comb__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__inst_sig_cluster_csr__0(Vsig_topology_top_sig_cluster_csr* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vsig_topology_top_sig_cluster_csr___stl_comb__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__inst_sig_cluster_csr__0\n"); );
    Vsig_topology_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
