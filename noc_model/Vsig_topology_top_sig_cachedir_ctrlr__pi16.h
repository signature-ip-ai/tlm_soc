...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_CACHEDIR_CTRLR__PI16_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_CACHEDIR_CTRLR__PI16_H_  // guard

#include "systemc"
#include "verilated_sc.h"
#include "verilated.h"
class Vsig_topology_top_sig_fifo_synchclk_flop_match__pi37;
class Vsig_topology_top_sig_sram_init__Sa;


class Vsig_topology_top__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_cachedir_ctrlr__pi16 final : public VerilatedModule {
  public:
    // CELLS
    Vsig_topology_top_sig_fifo_synchclk_flop_match__pi37* __PVT__cmqfifo_0;
    ...
    struct {
        ...
        SData/*9:0*/ __PVT__cache_index_rd_nxt;
        ...
        SData/*9:0*/ __Vdly__cache_index_rd;
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_cachedir_ctrlr__pi16(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_cachedir_ctrlr__pi16();
    VL_UNCOPYABLE(Vsig_topology_top_sig_cachedir_ctrlr__pi16);
