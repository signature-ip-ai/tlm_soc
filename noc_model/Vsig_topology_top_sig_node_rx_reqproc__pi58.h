...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_NODE_RX_REQPROC__PI58_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_NODE_RX_REQPROC__PI58_H_  // guard

#include "systemc"
#include "verilated_sc.h"
#include "verilated.h"
class Vsig_topology_top_sig_node_rx_reqproc_anyvc__pi65;


class Vsig_topology_top__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_node_rx_reqproc__pi58 final : public VerilatedModule {
  public:
    // CELLS
    Vsig_topology_top_sig_node_rx_reqproc_anyvc__pi65* __PVT__sig_node_rx_reqproc_vc0;
    ...
    struct {
        ...
        VlUnpacked<IData/*27:0*/, 2> __PVT__cm_flit_addr_sliced_pm;
        VlUnpacked<IData/*27:0*/, 2> __PVT__cm_homeaddr_base_pm;
        VlUnpacked<IData/*28:0*/, 2> __PVT__cm_homeaddr_limit_pm;
        VlUnpacked<IData/*27:0*/, 2> __PVT__cm_homeaddr_base_sliced_pm;
        VlUnpacked<IData/*28:0*/, 2> __PVT__cm_homeaddr_limit_sliced_pm;
        VlUnpacked<SData/*10:0*/, 2> __PVT__nodeid_pm;
        VlUnpacked<IData/*27:0*/, 2> __PVT__noncm_flit_addr_sliced_pm;
        VlUnpacked<IData/*27:0*/, 2> __PVT__noncm_homeaddr_base_pm;
        VlUnpacked<IData/*28:0*/, 2> __PVT__noncm_homeaddr_limit_pm;
        VlUnpacked<IData/*27:0*/, 2> __PVT__noncm_homeaddr_base_sliced_pm;
        VlUnpacked<IData/*28:0*/, 2> __PVT__noncm_homeaddr_limit_sliced_pm;
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_node_rx_reqproc__pi58(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_node_rx_reqproc__pi58();
    VL_UNCOPYABLE(Vsig_topology_top_sig_node_rx_reqproc__pi58);
