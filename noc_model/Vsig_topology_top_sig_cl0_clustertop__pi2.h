...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_CL0_CLUSTERTOP__PI2_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_CL0_CLUSTERTOP__PI2_H_  // guard

#include "systemc"
#include "verilated_sc.h"
#include "verilated.h"
class Vsig_topology_top_sig_cl0_clustercore__pi3;


class Vsig_topology_top__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_cl0_clustertop__pi2 final : public VerilatedModule {
  public:
    // CELLS
    Vsig_topology_top_sig_cl0_clustercore__pi3* __PVT__inst_cl0_clustercore;
    ...
    struct {
        ...
        VL_IN8(__PVT__p1_RX_REQFLITPEND,0,0);
        VL_IN8(__PVT__p1_RX_REQFLITV,0,0);
        VL_OUT8(__PVT__p1_RX_REQLCRDV,0,0);
        ...
        VL_OUT8(__PVT__p1_TX_SNPFLITPEND,0,0);
        VL_OUT8(__PVT__p1_TX_SNPFLITV,0,0);
        VL_IN8(__PVT__p1_TX_SNPLCRDV,0,0);
        VL_OUT8(__PVT__p1_TX_RSPFLITPEND,0,0);
        VL_OUT8(__PVT__p1_TX_RSPFLITV,0,0);
        VL_IN8(__PVT__p1_TX_RSPLCRDV,0,0);
        ...
        VL_IN8(__PVT__p1_SYSCOREQ,0,0);
        VL_OUT8(__PVT__p1_SYSCOACK,0,0);
        VL_IN8(__PVT__p1_reg_syscoh,1,0);
        ...
        VL_OUT8(__PVT__p3_TX_REQFLITPEND,0,0);
        VL_OUT8(__PVT__p3_TX_REQFLITV,0,0);
        VL_IN8(__PVT__p3_TX_REQLCRDV,0,0);
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_cl0_clustertop__pi2(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_cl0_clustertop__pi2();
    VL_UNCOPYABLE(Vsig_topology_top_sig_cl0_clustertop__pi2);
