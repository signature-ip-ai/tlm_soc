...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_FIFO_SYNCHCLK_FLOP__PI50_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_FIFO_SYNCHCLK_FLOP__PI50_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_fifo_synchclk_flop__pi50 final : public VerilatedModule {
  public:
    ...
    VlWide<3>/*72:0*/ __VdlyVal__fifo_loc__v4;
    VlWide<3>/*72:0*/ __VdlyVal__fifo_loc__v5;
    VlWide<3>/*72:0*/ __VdlyVal__fifo_loc__v6;
    VlWide<3>/*72:0*/ __VdlyVal__fifo_loc__v7;
    VlUnpacked<VlWide<3>/*72:0*/, 8> __PVT__fifo_loc_nxt;
    VlUnpacked<VlWide<3>/*72:0*/, 8> __PVT__fifo_loc;

    // INTERNAL VARIABLES
    Vsig_topology_top__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vsig_topology_top_sig_fifo_synchclk_flop__pi50(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_fifo_synchclk_flop__pi50();
    VL_UNCOPYABLE(Vsig_topology_top_sig_fifo_synchclk_flop__pi50);
