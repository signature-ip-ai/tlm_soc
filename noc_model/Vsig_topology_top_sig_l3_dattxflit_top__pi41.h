...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_L3_DATTXFLIT_TOP__PI41_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_L3_DATTXFLIT_TOP__PI41_H_  // guard

#include "systemc"
#include "verilated_sc.h"
#include "verilated.h"
class Vsig_topology_top_sig_fifo_synchclk_flop__pi54;
class Vsig_topology_top_sig_l3_arbtop;
class Vsig_topology_top_sig_l3_txflit_mux__F2ae;


class Vsig_topology_top__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_l3_dattxflit_top__pi41 final : public VerilatedModule {
  public:
    // CELLS
    Vsig_topology_top_sig_l3_arbtop* __PVT__sig_l3_arbtop_0;
    Vsig_topology_top_sig_l3_txflit_mux__F2ae* __PVT__sig_l3_txflit_mux_0;
    Vsig_topology_top_sig_fifo_synchclk_flop__pi54* __PVT__flit_store_fifo_0;
    ...
    CData/*0:0*/ __PVT__full_flit_store_fifo_dummy;
    ...
    CData/*0:0*/ __PVT__rddata_creditfifo;
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_l3_dattxflit_top__pi41(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_l3_dattxflit_top__pi41();
    VL_UNCOPYABLE(Vsig_topology_top_sig_l3_dattxflit_top__pi41);
