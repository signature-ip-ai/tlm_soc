...
VL_ATTR_COLD void Vsig_topology_top_sig_node_rx_rspproc__P49_Uz1___ctor_var_reset(Vsig_topology_top_sig_node_rx_rspproc__P49_Uz1* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vsig_topology_top_sig_node_rx_rspproc__P49_Uz1___ctor_var_reset\n"); );
    ...
    VL_SCOPED_RAND_RESET_W(79, vlSelf->__PVT__flit_out_vc0, __VscopeHash, 3622398562474296952ull);
    VL_SCOPED_RAND_RESET_W(79, vlSelf->__PVT__flit_out_vc1, __VscopeHash, 4252838621045558912ull);
    ...
    vlSelf->__PVT__o_rxtop_rspproc_fifo_is_full_vc0 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 9917585204043624663ull);
    ...
    vlSelf->__PVT__rxtop_rspproc_fifo_is_full_vc1 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 14836923495342064386ull);
    VL_SCOPED_RAND_RESET_W(73, vlSelf->__PVT__ic_RX_RSPFLIT_s, __VscopeHash, 17772401562615565751ull);
    VL_SCOPED_RAND_RESET_W(73, vlSelf->__PVT__ic_RX_FLIT_modified, __VscopeHash, 1950009161238542041ull);
    vlSelf->__PVT__rden_snprsp_flit_fifo_tx_snp_vc0 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 9844704620764731286ull);
    vlSelf->__PVT__rden_snprsp_flit_fifo_tx_snp_vc1 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 1230159064498555431ull);
    vlSelf->__PVT__snpresp_flit_is_vc0 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 5177516457631707077ull);
    vlSelf->__PVT__snpresp_flit_is_vc1 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 5758156822742864534ull);
    vlSelf->__PVT__snpresp_available_sysco_disabled_vc0 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 9454886253663941269ull);
    vlSelf->__PVT__snpresp_available_sysco_disabled_vc1 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 12717237523127437929ull);
    VL_SCOPED_RAND_RESET_W(73, vlSelf->__PVT__rddata_snprsp_flit_fifo_tx_snp_s, __VscopeHash, 8060517423761330452ull);
    VL_SCOPED_RAND_RESET_W(73, vlSelf->__Vcellinp__sig_node_rx_rspproc_vc0__ic_RX_FLIT, __VscopeHash, 6965295916294849378ull);
    VL_SCOPED_RAND_RESET_W(73, vlSelf->__Vcellinp__sig_node_rx_rspproc_vc1__ic_RX_FLIT, __VscopeHash, 4878480592128352197ull);
