...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_ID_TRANSLATOR_RN_SNP__PI56_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_ID_TRANSLATOR_RN_SNP__PI56_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_id_translator_rn_snp__pi56 final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*1:0*/ __Vfunc_clog2_index__2__Vfuncout;
        CData/*3:0*/ __Vfunc_clog2_index__2__set_bit_location;
        CData/*2:0*/ __Vfunc_all_bits_sum_up__3__Vfuncout;
        CData/*3:0*/ __Vfunc_all_bits_sum_up__3__set_bit_location;
        CData/*0:0*/ __Vfunc_all_bits_sum_up__3__tmp_overflow;
    };
    struct {
        ...
        IData/*31:0*/ __Vfunc_clog2_index__2__unnamedblk2__DOT__i;
        IData/*31:0*/ __Vfunc_all_bits_sum_up__3__unnamedblk3__DOT__i;
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_id_translator_rn_snp__pi56(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_id_translator_rn_snp__pi56();
    VL_UNCOPYABLE(Vsig_topology_top_sig_id_translator_rn_snp__pi56);
