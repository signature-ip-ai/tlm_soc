...
VL_ATTR_COLD void Vsig_topology_top_sig_node_porttop__pi28___eval_initial__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_node_porttop_sn_p1__node_porttop_sn__DOT__u_node_porttop_sn(Vsig_topology_top_sig_node_porttop__pi28* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vsig_topology_top_sig_node_porttop__pi28___eval_initial__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_node_porttop_sn_p1__node_porttop_sn__DOT__u_node_porttop_sn\n"); );
    Vsig_topology_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__enable_balanced_routing = 0U;
    vlSelfRef.__PVT__id_translator_full_req = 0U;
    vlSelfRef.__PVT__id_translator_hs_pending_txn_snp = 0U;
    vlSelfRef.__PVT__timeout_mode = 0U;
    vlSelfRef.__PVT__recovery_mode = 0U;
}

VL_ATTR_COLD void Vsig_topology_top_sig_node_porttop__pi28___stl_comb__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_node_porttop_sn_p1__node_porttop_sn__DOT__u_node_porttop_sn__1(Vsig_topology_top_sig_node_porttop__pi28* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vsig_topology_top_sig_node_porttop__pi28___stl_comb__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_node_porttop_sn_p1__node_porttop_sn__DOT__u_node_porttop_sn__1\n"); );
    Vsig_topology_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vsig_topology_top_sig_node_porttop__pi28___eval_initial__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_node_porttop_sn_p0__node_porttop_sn__DOT__u_node_porttop_sn(Vsig_topology_top_sig_node_porttop__pi28* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vsig_topology_top_sig_node_porttop__pi28___eval_initial__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_node_porttop_sn_p0__node_porttop_sn__DOT__u_node_porttop_sn\n"); );
    Vsig_topology_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__enable_balanced_routing = 0U;
...
VL_ATTR_COLD void Vsig_topology_top_sig_node_porttop__pi28___stl_comb__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_node_porttop_sn_p0__node_porttop_sn__DOT__u_node_porttop_sn__1(Vsig_topology_top_sig_node_porttop__pi28* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vsig_topology_top_sig_node_porttop__pi28___stl_comb__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_node_porttop_sn_p0__node_porttop_sn__DOT__u_node_porttop_sn__1\n"); );
    Vsig_topology_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__rx_activate_clk = ((((IData)(vlSelfRef.__PVT__ic_RX_REQFLITPEND) 
...
VL_ATTR_COLD void Vsig_topology_top_sig_node_porttop__pi28___ctor_var_reset(Vsig_topology_top_sig_node_porttop__pi28* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vsig_topology_top_sig_node_porttop__pi28___ctor_var_reset\n"); );
    Vsig_topology_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    VL_SCOPED_RAND_RESET_W(151, vlSelf->__PVT__id_translator_sn__DOT__req_flit_to_id_translator, __VscopeHash, 4293820566372360381ull);
    VL_SCOPED_RAND_RESET_W(151, vlSelf->__PVT__id_translator_sn__DOT__req_flit_from_id_translator, __VscopeHash, 6207798992151168750ull);
    vlSelf->__PVT__id_translator_sn__DOT__tx_req_txnid_to_sn = VL_SCOPED_RAND_RESET_I(12, __VscopeHash, 5470520456836478635ull);
    vlSelf->__PVT__id_translator_sn__DOT__tx_req_addr_to_sn = VL_SCOPED_RAND_RESET_Q(52, __VscopeHash, 18273213445823657197ull);
    vlSelf->__PVT__id_translator_sn__DOT__tx_req_returntxnid_to_sn = VL_SCOPED_RAND_RESET_I(12, __VscopeHash, 5698915810453455021ull);
    vlSelf->__PVT__id_translator_sn__DOT__tx_req_apply_dmt_from_hn = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 8707607009977452516ull);
    vlSelf->__PVT__id_translator_sn__DOT__unused_signal = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 1866341448863828301ull);
    vlSelf->__PVT__id_translator_sn__DOT__unused_signal_nxt = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 2804390964674675910ull);
    vlSelf->__Vcellinp__id_translator_sn__DOT__sig_addr_translator_0__i_tx_req_addr = VL_SCOPED_RAND_RESET_Q(52, __VscopeHash, 5887049231618243057ull);
    vlSelf->__Vcellinp__id_translator_sn__DOT__sig_id_translator_sn_0__vc1_rx_dat_dbid_from_sn = VL_SCOPED_RAND_RESET_I(12, __VscopeHash, 10965829976163847335ull);
    vlSelf->__Vcellinp__id_translator_sn__DOT__sig_id_translator_sn_0__vc1_rx_dat_txnid_from_sn = VL_SCOPED_RAND_RESET_I(12, __VscopeHash, 8711040234665133805ull);
    vlSelf->__Vcellinp__id_translator_sn__DOT__sig_id_translator_sn_0__vc1_rx_dat_opcode = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 1270634484428808691ull);
    vlSelf->__Vcellinp__id_translator_sn__DOT__sig_id_translator_sn_0__vc1_rx_dat_v = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 5790324708175682924ull);
    vlSelf->__Vcellinp__id_translator_sn__DOT__sig_id_translator_sn_0__vc0_rx_dat_dbid_from_sn = VL_SCOPED_RAND_RESET_I(12, __VscopeHash, 12303969395012576240ull);
    vlSelf->__Vcellinp__id_translator_sn__DOT__sig_id_translator_sn_0__vc0_rx_dat_txnid_from_sn = VL_SCOPED_RAND_RESET_I(12, __VscopeHash, 117733111782630898ull);
    vlSelf->__Vcellinp__id_translator_sn__DOT__sig_id_translator_sn_0__vc0_rx_dat_opcode = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 7958634129003725213ull);
    vlSelf->__Vcellinp__id_translator_sn__DOT__sig_id_translator_sn_0__vc0_rx_dat_v = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 219805496319776710ull);
    vlSelf->__Vcellinp__id_translator_sn__DOT__sig_id_translator_sn_0__vc1_rx_rsp_txnid_from_sn = VL_SCOPED_RAND_RESET_I(12, __VscopeHash, 15608822347935555116ull);
    vlSelf->__Vcellinp__id_translator_sn__DOT__sig_id_translator_sn_0__vc1_rx_rsp_opcode = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 11698464387991960495ull);
    vlSelf->__Vcellinp__id_translator_sn__DOT__sig_id_translator_sn_0__vc1_rx_rsp_v = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 12945553044657050922ull);
    vlSelf->__Vcellinp__id_translator_sn__DOT__sig_id_translator_sn_0__vc0_rx_rsp_txnid_from_sn = VL_SCOPED_RAND_RESET_I(12, __VscopeHash, 18211678554462630702ull);
    vlSelf->__Vcellinp__id_translator_sn__DOT__sig_id_translator_sn_0__vc0_rx_rsp_opcode = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 12002088650610781310ull);
    vlSelf->__Vcellinp__id_translator_sn__DOT__sig_id_translator_sn_0__vc0_rx_rsp_v = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 17542584863038297499ull);
    vlSelf->__Vcellinp__id_translator_sn__DOT__sig_id_translator_sn_0__tx_req_returntxnid_from_hn = VL_SCOPED_RAND_RESET_I(12, __VscopeHash, 13291579102898001818ull);
    vlSelf->__Vcellinp__id_translator_sn__DOT__sig_id_translator_sn_0__tx_req_txnid_from_hn = VL_SCOPED_RAND_RESET_I(12, __VscopeHash, 8042981755561301053ull);
    vlSelf->__Vcellinp__id_translator_sn__DOT__sig_id_translator_sn_0__tx_req_order = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 3987359240699806130ull);
    vlSelf->__Vcellinp__id_translator_sn__DOT__sig_id_translator_sn_0__tx_req_opcode = VL_SCOPED_RAND_RESET_I(7, __VscopeHash, 1792899151121364262ull);
    ...
    vlSelf->__Vdly__id_translator_sn__DOT__unused_signal = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 11391486434515899320ull);
}
