...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_NODE_TXTOP__PI44_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_NODE_TXTOP__PI44_H_  // guard
...
class Vsig_topology_top_sig_node_dattxflit_top__pi60;
class Vsig_topology_top_sig_node_rsptxflit_top;
class Vsig_topology_top_sig_node_snptxflit_top__pi59;


class Vsig_topology_top__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_node_txtop__pi44 final : public VerilatedModule {
  public:
    // CELLS
    Vsig_topology_top_sig_node_snptxflit_top__pi59* __PVT__sig_node_snptxflit_top_0;
    Vsig_topology_top_sig_node_rsptxflit_top* __PVT__sig_node_rsptxflit_top_0;
    Vsig_topology_top_sig_node_dattxflit_top__pi60* __PVT__sig_node_dattxflit_top_0;
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_node_txtop__pi44(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_node_txtop__pi44();
    VL_UNCOPYABLE(Vsig_topology_top_sig_node_txtop__pi44);
