...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_NODE_RXTOP__PI42_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_NODE_RXTOP__PI42_H_  // guard
...
class Vsig_topology_top_sig_node_rx_reqproc__pi56;
class Vsig_topology_top_sig_node_rx_rspproc__P49_Uz1;


class Vsig_topology_top__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_node_rxtop__pi42 final : public VerilatedModule {
  public:
    // CELLS
    Vsig_topology_top_sig_node_rx_reqproc__pi56* __PVT__sig_node_rx_reqproc_0;
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_node_rxtop__pi42(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_node_rxtop__pi42();
    VL_UNCOPYABLE(Vsig_topology_top_sig_node_rxtop__pi42);
