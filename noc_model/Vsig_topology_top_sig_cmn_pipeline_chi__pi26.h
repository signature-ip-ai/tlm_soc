...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_CMN_PIPELINE_CHI__PI26_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_CMN_PIPELINE_CHI__PI26_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_cmn_pipeline_chi__pi26 final : public VerilatedModule {
  public:
    // CELLS
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_cmn_pipeline_chi__pi26(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_cmn_pipeline_chi__pi26();
    VL_UNCOPYABLE(Vsig_topology_top_sig_cmn_pipeline_chi__pi26);
