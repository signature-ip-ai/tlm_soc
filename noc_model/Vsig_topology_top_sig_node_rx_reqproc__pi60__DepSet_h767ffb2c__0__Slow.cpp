...
VL_ATTR_COLD void Vsig_topology_top_sig_node_rx_reqproc__pi60___ctor_var_reset(Vsig_topology_top_sig_node_rx_reqproc__pi60* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vsig_topology_top_sig_node_rx_reqproc__pi60___ctor_var_reset\n"); );
