...
VL_ATTR_COLD void Vsig_topology_top_sig_tx_portarb___stl_comb__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_node_porttop_sn_p0__node_porttop_sn__DOT__u_node_porttop_sn__sig_node_txtop_0__sig_node_rsptxflit_top_0__sig_node_arbtop_0__sig_tx_portarb_vc0__0(Vsig_topology_top_sig_tx_portarb* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                      Vsig_topology_top_sig_tx_portarb___stl_comb__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_node_porttop_sn_p0__node_porttop_sn__DOT__u_node_porttop_sn__sig_node_txtop_0__sig_node_rsptxflit_top_0__sig_node_arbtop_0__sig_tx_portarb_vc0__0\n"); );
...
VL_ATTR_COLD void Vsig_topology_top_sig_tx_portarb___stl_comb__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_node_porttop_sn_p0__node_porttop_sn__DOT__u_node_porttop_sn__sig_node_txtop_0__sig_node_rsptxflit_top_0__sig_node_arbtop_0__sig_tx_portarb_vc1__0(Vsig_topology_top_sig_tx_portarb* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                      Vsig_topology_top_sig_tx_portarb___stl_comb__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_node_porttop_sn_p0__node_porttop_sn__DOT__u_node_porttop_sn__sig_node_txtop_0__sig_node_rsptxflit_top_0__sig_node_arbtop_0__sig_tx_portarb_vc1__0\n"); );
    Vsig_topology_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__end_req_qual = (0U != (VL_EXTEND_II(32,10, (IData)(vlSelfRef.__PVT__gnt_vec)) 
...
VL_ATTR_COLD void Vsig_topology_top_sig_tx_portarb___stl_comb__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_node_porttop_sn_p0__node_porttop_sn__DOT__u_node_porttop_sn__sig_node_txtop_0__sig_node_dattxflit_top_0__sig_node_arbtop_0__sig_tx_portarb_vc0__0(Vsig_topology_top_sig_tx_portarb* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                      Vsig_topology_top_sig_tx_portarb___stl_comb__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_node_porttop_sn_p0__node_porttop_sn__DOT__u_node_porttop_sn__sig_node_txtop_0__sig_node_dattxflit_top_0__sig_node_arbtop_0__sig_tx_portarb_vc0__0\n"); );
    Vsig_topology_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__end_req_qual = (0U != (VL_EXTEND_II(32,10, (IData)(vlSelfRef.__PVT__gnt_vec)) 
...
VL_ATTR_COLD void Vsig_topology_top_sig_tx_portarb___stl_comb__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_node_porttop_sn_p0__node_porttop_sn__DOT__u_node_porttop_sn__sig_node_txtop_0__sig_node_dattxflit_top_0__sig_node_arbtop_0__sig_tx_portarb_vc1__0(Vsig_topology_top_sig_tx_portarb* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                      Vsig_topology_top_sig_tx_portarb___stl_comb__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_node_porttop_sn_p0__node_porttop_sn__DOT__u_node_porttop_sn__sig_node_txtop_0__sig_node_dattxflit_top_0__sig_node_arbtop_0__sig_tx_portarb_vc1__0\n"); );
    Vsig_topology_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__end_req_qual = (0U != (VL_EXTEND_II(32,10, (IData)(vlSelfRef.__PVT__gnt_vec)) 
...
VL_ATTR_COLD void Vsig_topology_top_sig_tx_portarb___ctor_var_reset(Vsig_topology_top_sig_tx_portarb* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                      Vsig_topology_top_sig_tx_portarb___ctor_var_reset\n"); );
    Vsig_topology_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    vlSelf->__PVT__req_vec = VL_SCOPED_RAND_RESET_I(10, __VscopeHash, 3671060821001920143ull);
    vlSelf->__PVT__end_req_vec = VL_SCOPED_RAND_RESET_I(10, __VscopeHash, 16225919218991291471ull);
    vlSelf->__PVT__gnt_vec = VL_SCOPED_RAND_RESET_I(10, __VscopeHash, 13390058090934930815ull);
    vlSelf->__PVT__end_req_qual = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 176696963185292797ull);
    vlSelf->__PVT__relative_req_vec = VL_SCOPED_RAND_RESET_I(10, __VscopeHash, 15141973156945751920ull);
    vlSelf->__PVT__grant_posn = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 15346585686553996140ull);
    vlSelf->__PVT__grant_posn_nxt = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 5886570316349505929ull);
    ...
    vlSelf->__PVT__gnt_vec_nxt = VL_SCOPED_RAND_RESET_I(10, __VscopeHash, 2754516603946840551ull);
    vlSelf->__PVT__any_req_asserted = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 4611442517702190146ull);
    vlSelf->__PVT__rel_req_highest_priority = VL_SCOPED_RAND_RESET_I(10, __VscopeHash, 404292215607601192ull);
    vlSelf->__Vdly__arbstate = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 7481372124911311414ull);
    vlSelf->__Vdly__gnt_vec = VL_SCOPED_RAND_RESET_I(10, __VscopeHash, 1359409510409493573ull);
    vlSelf->__Vdly__grant_posn = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 9345302041815929885ull);
}
