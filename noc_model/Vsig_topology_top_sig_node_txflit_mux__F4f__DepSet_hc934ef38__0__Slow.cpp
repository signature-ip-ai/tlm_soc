...
VL_ATTR_COLD void Vsig_topology_top_sig_node_txflit_mux__F4f___stl_comb__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_node_porttop_rn_p1__node_porttop_rn__DOT__u_node_porttop_rn__sig_node_txtop_0__sig_node_rsptxflit_top_0__sig_node_txflit_mux_0__0(Vsig_topology_top_sig_node_txflit_mux__F4f* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    Vsig_topology_top_sig_node_txflit_mux__F4f___stl_comb__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_node_porttop_rn_p1__node_porttop_rn__DOT__u_node_porttop_rn__sig_node_txtop_0__sig_node_rsptxflit_top_0__sig_node_txflit_mux_0__0\n"); );
...
VL_ATTR_COLD void Vsig_topology_top_sig_node_txflit_mux__F4f___stl_comb__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_node_porttop_rn_p1__node_porttop_rn__DOT__u_node_porttop_rn__sig_node_txtop_0__sig_node_rsptxflit_top_0__sig_node_txflit_mux_0__1(Vsig_topology_top_sig_node_txflit_mux__F4f* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    Vsig_topology_top_sig_node_txflit_mux__F4f___stl_comb__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_node_porttop_rn_p1__node_porttop_rn__DOT__u_node_porttop_rn__sig_node_txtop_0__sig_node_rsptxflit_top_0__sig_node_txflit_mux_0__1\n"); );
    Vsig_topology_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
VL_ATTR_COLD void Vsig_topology_top_sig_node_txflit_mux__F4f___stl_comb__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_node_porttop_sn_p3__node_porttop_sn__DOT__u_node_porttop_sn__sig_node_txtop_0__sig_node_rsptxflit_top_0__sig_node_txflit_mux_0__0(Vsig_topology_top_sig_node_txflit_mux__F4f* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    Vsig_topology_top_sig_node_txflit_mux__F4f___stl_comb__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_node_porttop_sn_p3__node_porttop_sn__DOT__u_node_porttop_sn__sig_node_txtop_0__sig_node_rsptxflit_top_0__sig_node_txflit_mux_0__0\n"); );
    Vsig_topology_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__any_gnt_vc1 = (0U != (IData)(vlSelfRef.__PVT__gnt_vec_vc1));
...
VL_ATTR_COLD void Vsig_topology_top_sig_node_txflit_mux__F4f___stl_comb__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_node_porttop_sn_p3__node_porttop_sn__DOT__u_node_porttop_sn__sig_node_txtop_0__sig_node_rsptxflit_top_0__sig_node_txflit_mux_0__1(Vsig_topology_top_sig_node_txflit_mux__F4f* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    Vsig_topology_top_sig_node_txflit_mux__F4f___stl_comb__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_node_porttop_sn_p3__node_porttop_sn__DOT__u_node_porttop_sn__sig_node_txtop_0__sig_node_rsptxflit_top_0__sig_node_txflit_mux_0__1\n"); );
    Vsig_topology_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    VlWide<3>/*95:0*/ __Vtemp_1;
...
VL_ATTR_COLD void Vsig_topology_top_sig_node_txflit_mux__F4f___ctor_var_reset(Vsig_topology_top_sig_node_txflit_mux__F4f* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    Vsig_topology_top_sig_node_txflit_mux__F4f___ctor_var_reset\n"); );
    Vsig_topology_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    VL_SCOPED_RAND_RESET_W(79, vlSelf->__PVT__flit_out, __VscopeHash, 10954420838652254973ull);
    for (int __Vi0 = 0; __Vi0 < 10; ++__Vi0) {
        VL_SCOPED_RAND_RESET_W(79, vlSelf->__PVT__flit_in_vc0[__Vi0], __VscopeHash, 14188575403587474835ull);
    }
    for (int __Vi0 = 0; __Vi0 < 10; ++__Vi0) {
        VL_SCOPED_RAND_RESET_W(79, vlSelf->__PVT__flit_in_vc1[__Vi0], __VscopeHash, 5104417528355624980ull);
    }
    vlSelf->__PVT__flitv_out_nxt = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 11982075515191814129ull);
    VL_SCOPED_RAND_RESET_W(79, vlSelf->__PVT__flit_out_nxt, __VscopeHash, 6090622116806152946ull);
    ...
    for (int __Vi0 = 0; __Vi0 < 10; ++__Vi0) {
        VL_SCOPED_RAND_RESET_W(79, vlSelf->__PVT__flit_in_eithervc[__Vi0], __VscopeHash, 1416600860221975958ull);
    }
    ...
    VL_SCOPED_RAND_RESET_W(79, vlSelf->__Vdly__flit_out, __VscopeHash, 6285439179653308622ull);
}
