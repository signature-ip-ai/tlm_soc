...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_FIFO_SYNCHCLK_FLOP__FB6D_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_FIFO_SYNCHCLK_FLOP__FB6D_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_fifo_synchclk_flop__FB6d final : public VerilatedModule {
  public:
    ...
    VlUnpacked<VlWide<4>/*108:0*/, 16> __PVT__fifo_loc_nxt;
    VlUnpacked<VlWide<4>/*108:0*/, 16> __PVT__fifo_loc;

    // INTERNAL VARIABLES
    Vsig_topology_top__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vsig_topology_top_sig_fifo_synchclk_flop__FB6d(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_fifo_synchclk_flop__FB6d();
    VL_UNCOPYABLE(Vsig_topology_top_sig_fifo_synchclk_flop__FB6d);
