...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_L3TOP__PI7_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_L3TOP__PI7_H_  // guard

#include "systemc"
#include "verilated_sc.h"
#include "verilated.h"
class Vsig_topology_top_sig_slc_bypass__pi21;


class Vsig_topology_top__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_L3top__pi7 final : public VerilatedModule {
  public:
    // CELLS
    Vsig_topology_top_sig_slc_bypass__pi21* __PVT__sig_slc_bypass_gen_blk__DOT__sig_slc_bypass_0;
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_L3top__pi7(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_L3top__pi7();
    VL_UNCOPYABLE(Vsig_topology_top_sig_L3top__pi7);
