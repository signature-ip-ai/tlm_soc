...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_NODE_PORTTOP_WRAPPER__PI10_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_NODE_PORTTOP_WRAPPER__PI10_H_  // guard

#include "systemc"
#include "verilated_sc.h"
#include "verilated.h"
class Vsig_topology_top_sig_cmn_pipeline_chi__pi27;
class Vsig_topology_top_sig_node_porttop__pi28;


class Vsig_topology_top__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_node_porttop_wrapper__pi10 final : public VerilatedModule {
  public:
    // CELLS
    Vsig_topology_top_sig_cmn_pipeline_chi__pi27* __PVT__node_porttop_sn__DOT__u_sig_cmn_pipeline_sn;
    Vsig_topology_top_sig_node_porttop__pi28* __PVT__node_porttop_sn__DOT__u_node_porttop_sn;
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_node_porttop_wrapper__pi10(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_node_porttop_wrapper__pi10();
    VL_UNCOPYABLE(Vsig_topology_top_sig_node_porttop_wrapper__pi10);
