...
VL_ATTR_COLD void Vsig_topology_top_sig_node_rxtop__pi44___ctor_var_reset(Vsig_topology_top_sig_node_rxtop__pi44* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vsig_topology_top_sig_node_rxtop__pi44___ctor_var_reset\n"); );
