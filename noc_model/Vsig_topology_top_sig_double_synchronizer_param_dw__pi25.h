...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_DOUBLE_SYNCHRONIZER_PARAM_DW__PI25_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_DOUBLE_SYNCHRONIZER_PARAM_DW__PI25_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_double_synchronizer_param_dw__pi25 final : public VerilatedModule {
  public:
    // CELLS
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_double_synchronizer_param_dw__pi25(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_double_synchronizer_param_dw__pi25();
    VL_UNCOPYABLE(Vsig_topology_top_sig_double_synchronizer_param_dw__pi25);
