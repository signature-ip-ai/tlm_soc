...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_NODE_TXTOP__PI45_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_NODE_TXTOP__PI45_H_  // guard
...
class Vsig_topology_top_sig_node_dattxflit_top__pi61;
class Vsig_topology_top_sig_node_rsptxflit_top;
class Vsig_topology_top_sig_node_snptxflit_top__pi60;


class Vsig_topology_top__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_node_txtop__pi45 final : public VerilatedModule {
  public:
    // CELLS
    Vsig_topology_top_sig_node_snptxflit_top__pi60* __PVT__sig_node_snptxflit_top_0;
    Vsig_topology_top_sig_node_rsptxflit_top* __PVT__sig_node_rsptxflit_top_0;
    Vsig_topology_top_sig_node_dattxflit_top__pi61* __PVT__sig_node_dattxflit_top_0;
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_node_txtop__pi45(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_node_txtop__pi45();
    VL_UNCOPYABLE(Vsig_topology_top_sig_node_txtop__pi45);
