...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_CHI_XMT_SNPREQ__PI18_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_CHI_XMT_SNPREQ__PI18_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_chi_xmt_snpreq__pi18 final : public VerilatedModule {
  public:
    // CELLS
    ...
    struct {
        ...
        VL_IN8(__PVT__dat_link_crdt_avlble,0,0);
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_chi_xmt_snpreq__pi18(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_chi_xmt_snpreq__pi18();
    VL_UNCOPYABLE(Vsig_topology_top_sig_chi_xmt_snpreq__pi18);
