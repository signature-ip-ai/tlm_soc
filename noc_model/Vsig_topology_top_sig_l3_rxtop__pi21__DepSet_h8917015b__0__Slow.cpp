...
VL_ATTR_COLD void Vsig_topology_top_sig_l3_rxtop__pi21___ctor_var_reset(Vsig_topology_top_sig_l3_rxtop__pi21* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vsig_topology_top_sig_l3_rxtop__pi21___ctor_var_reset\n"); );
