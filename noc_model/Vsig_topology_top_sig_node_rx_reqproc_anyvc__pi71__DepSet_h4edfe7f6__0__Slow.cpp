...
VL_ATTR_COLD void Vsig_topology_top_sig_node_rx_reqproc_anyvc__pi71___eval_initial__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_node_porttop_sn_p1__node_porttop_sn__DOT__u_node_porttop_sn__sig_node_rxtop_0__sig_node_rx_reqproc_0__sig_node_rx_reqproc_vc0(Vsig_topology_top_sig_node_rx_reqproc_anyvc__pi71* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    Vsig_topology_top_sig_node_rx_reqproc_anyvc__pi71___eval_initial__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_node_porttop_sn_p1__node_porttop_sn__DOT__u_node_porttop_sn__sig_node_rxtop_0__sig_node_rx_reqproc_0__sig_node_rx_reqproc_vc0\n"); );
...
VL_ATTR_COLD void Vsig_topology_top_sig_node_rx_reqproc_anyvc__pi71___eval_initial__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_node_porttop_sn_p0__node_porttop_sn__DOT__u_node_porttop_sn__sig_node_rxtop_0__sig_node_rx_reqproc_0__sig_node_rx_reqproc_vc0(Vsig_topology_top_sig_node_rx_reqproc_anyvc__pi71* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    Vsig_topology_top_sig_node_rx_reqproc_anyvc__pi71___eval_initial__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_node_porttop_sn_p0__node_porttop_sn__DOT__u_node_porttop_sn__sig_node_rxtop_0__sig_node_rx_reqproc_0__sig_node_rx_reqproc_vc0\n"); );
    Vsig_topology_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__my_topology_x = 0U;
...
VL_ATTR_COLD void Vsig_topology_top_sig_node_rx_reqproc_anyvc__pi71___ctor_var_reset(Vsig_topology_top_sig_node_rx_reqproc_anyvc__pi71* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    Vsig_topology_top_sig_node_rx_reqproc_anyvc__pi71___ctor_var_reset\n"); );
    Vsig_topology_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    VL_SCOPED_RAND_RESET_W(151, vlSelf->__PVT__ic_RX_FLIT, __VscopeHash, 13586822630252626842ull);
    ...
    VL_SCOPED_RAND_RESET_W(151, vlSelf->__PVT__flit_out_pyld, __VscopeHash, 14689513724446069492ull);
    vlSelf->__PVT__flit_out_meta = VL_SCOPED_RAND_RESET_I(10, __VscopeHash, 4781678093268733927ull);
    ...
    vlSelf->__PVT__empty_credit_fifo = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 14422874885873274031ull);
    ...
    VL_SCOPED_RAND_RESET_W(151, vlSelf->__PVT__write_data_fifo, __VscopeHash, 11498526385856397901ull);
    VL_SCOPED_RAND_RESET_W(151, vlSelf->__PVT__read_data_fifo, __VscopeHash, 15169263796891844761ull);
    VL_SCOPED_RAND_RESET_W(151, vlSelf->__PVT__read_data_fifo_s, __VscopeHash, 2154881700464928972ull);
    VL_SCOPED_RAND_RESET_W(151, vlSelf->__PVT__read_data_fifo_stored_s, __VscopeHash, 4216220924151580407ull);
    VL_SCOPED_RAND_RESET_W(151, vlSelf->__PVT__read_data_fifo_stored, __VscopeHash, 18266271290246763668ull);
    VL_SCOPED_RAND_RESET_W(151, vlSelf->__PVT__read_data_fifo_stored_nxt, __VscopeHash, 9236714825484219837ull);
    ...
    VL_SCOPED_RAND_RESET_W(151, vlSelf->__Vcellout__flit_fifo_default__DOT__flit_store_fifo_0__fifo_rddata, __VscopeHash, 562618857665099763ull);
    VL_SCOPED_RAND_RESET_W(151, vlSelf->__Vcellinp__flit_fifo_default__DOT__flit_store_fifo_0__fifo_wrdata, __VscopeHash, 7762093963973483101ull);
    vlSelf->__Vdly__xmtstate = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 13421361454766880576ull);
    VL_SCOPED_RAND_RESET_W(151, vlSelf->__Vdly__read_data_fifo_stored, __VscopeHash, 2990092295006844582ull);
}
