...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_L3_TXTOP__PI23_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_L3_TXTOP__PI23_H_  // guard

#include "systemc"
#include "verilated_sc.h"
#include "verilated.h"
class Vsig_topology_top_sig_ic_crdt_recv;
class Vsig_topology_top_sig_l3_dattxflit_top__pi42;
class Vsig_topology_top_sig_l3_rsptxflit_top__F3;


class Vsig_topology_top__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_l3_txtop__pi23 final : public VerilatedModule {
  public:
    // CELLS
    Vsig_topology_top_sig_l3_rsptxflit_top__F3* __PVT__sig_l3_rsptxflit_top_0;
    Vsig_topology_top_sig_l3_dattxflit_top__pi42* __PVT__sig_l3_dattxflit_top_0;
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_l3_txtop__pi23(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_l3_txtop__pi23();
    VL_UNCOPYABLE(Vsig_topology_top_sig_l3_txtop__pi23);
