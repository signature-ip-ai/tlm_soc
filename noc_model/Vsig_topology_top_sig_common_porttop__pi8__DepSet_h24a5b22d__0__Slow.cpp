...
VL_ATTR_COLD void Vsig_topology_top_sig_common_porttop__pi8___ctor_var_reset(Vsig_topology_top_sig_common_porttop__pi8* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vsig_topology_top_sig_common_porttop__pi8___ctor_var_reset\n"); );
