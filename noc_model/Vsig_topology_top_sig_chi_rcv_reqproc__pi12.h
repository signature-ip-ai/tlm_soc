...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_CHI_RCV_REQPROC__PI12_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_CHI_RCV_REQPROC__PI12_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_chi_rcv_reqproc__pi12 final : public VerilatedModule {
  public:
    // CELLS
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_chi_rcv_reqproc__pi12(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_chi_rcv_reqproc__pi12();
    VL_UNCOPYABLE(Vsig_topology_top_sig_chi_rcv_reqproc__pi12);
