...
VL_ATTR_COLD void Vsig_topology_top_sig_cc_rx_datproc_anyvc__pi49___ctor_var_reset(Vsig_topology_top_sig_cc_rx_datproc_anyvc__pi49* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vsig_topology_top_sig_cc_rx_datproc_anyvc__pi49___ctor_var_reset\n"); );
