...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_L3_RX_REQPROC_ANYVC__PI53_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_L3_RX_REQPROC_ANYVC__PI53_H_  // guard

#include "systemc"
#include "verilated_sc.h"
#include "verilated.h"
class Vsig_topology_top_sig_fifo_synchclk_flop__pi63;
class Vsig_topology_top_sig_routing_policy;


class Vsig_topology_top__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_l3_rx_reqproc_anyvc__pi53 final : public VerilatedModule {
  public:
    // CELLS
    Vsig_topology_top_sig_fifo_synchclk_flop__pi63* __PVT__flit_store_fifo_0;
    ...
    struct {
        ...
        CData/*1:0*/ __PVT__tgt_nodeid_fifoout_up;
        CData/*0:0*/ __PVT__req_or_snp_fifoout;
        CData/*0:0*/ __PVT__req_or_snp_fifoout_stored;
        CData/*0:0*/ __PVT__snp_multicast_fifoout;
        CData/*0:0*/ __PVT__snp_multicast_fifoout_stored;
        CData/*0:0*/ __PVT__drive_end_flit;
        CData/*0:0*/ __PVT__rden_storefifo;
        CData/*0:0*/ __PVT__send_hdr;
        CData/*5:0*/ __PVT__flit_out_meta;
        CData/*2:0*/ __PVT__mynode_id;
        ...
        CData/*7:0*/ __PVT__tgt_clusterid_fifoout_1stcycle;
        CData/*2:0*/ __PVT__tgt_portid_fifoout_1stcycle;
        CData/*1:0*/ __PVT__tgt_nodeid_fifoout_up_1stcycle;
        CData/*7:0*/ __PVT__tgt_clusterid_fifoout_stored;
        CData/*2:0*/ __PVT__tgt_portid_fifoout_stored;
        CData/*1:0*/ __PVT__tgt_nodeid_fifoout_up_stored;
        CData/*0:0*/ __PVT__srcid_bit0_fifoout;
        CData/*0:0*/ __PVT__srcid_bit0_fifoout_1stcycle;
        CData/*0:0*/ __PVT__srcid_bit0_fifoout_stored;
    ...
    struct {
        ...
        VlWide<5>/*151:0*/ __PVT__write_data_fifo;
        VlWide<5>/*151:0*/ __PVT__read_data_fifo;
        VlWide<5>/*151:0*/ __PVT__read_data_fifo_withbypass;
        VlWide<5>/*154:0*/ __PVT__flit_out_pl;
        VlWide<5>/*151:0*/ __PVT__read_data_fifo_stored;
        VlWide<5>/*151:0*/ __PVT__read_data_fifo_stored_nxt;
        VlWide<5>/*151:0*/ __Vdly__read_data_fifo_stored;
        VlWide<5>/*150:0*/ __PVT__read_data_fifo_stored_req_s;
        VlWide<5>/*150:0*/ __PVT__read_data_fifo_withbypass_req_s;
        VlWide<4>/*118:0*/ __PVT__read_data_fifo_stored_snp_s;
        VlWide<4>/*118:0*/ __PVT__read_data_fifo_withbypass_snp_s;
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_l3_rx_reqproc_anyvc__pi53(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_l3_rx_reqproc_anyvc__pi53();
    VL_UNCOPYABLE(Vsig_topology_top_sig_l3_rx_reqproc_anyvc__pi53);
