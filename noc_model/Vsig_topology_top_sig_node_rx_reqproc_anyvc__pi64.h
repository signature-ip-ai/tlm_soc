...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_NODE_RX_REQPROC_ANYVC__PI64_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_NODE_RX_REQPROC_ANYVC__PI64_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_node_rx_reqproc_anyvc__pi64 final : public VerilatedModule {
  public:
    // CELLS
    Vsig_topology_top_sig_routing_policy* __PVT__inst_sig_routing_policy;
    Vsig_topology_top_sig_fifo_synchclk_flop__pi71* __PVT__flit_fifo_default__DOT__flit_store_fifo_0;
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_node_rx_reqproc_anyvc__pi64(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_node_rx_reqproc_anyvc__pi64();
    VL_UNCOPYABLE(Vsig_topology_top_sig_node_rx_reqproc_anyvc__pi64);
