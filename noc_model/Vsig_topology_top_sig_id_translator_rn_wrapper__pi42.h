...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_ID_TRANSLATOR_RN_WRAPPER__PI42_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_ID_TRANSLATOR_RN_WRAPPER__PI42_H_  // guard

#include "systemc"
#include "verilated_sc.h"
#include "verilated.h"
class Vsig_topology_top_sig_id_translator_rn_req__pi56;
class Vsig_topology_top_sig_id_translator_rn_snp__pi55;


class Vsig_topology_top__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_id_translator_rn_wrapper__pi42 final : public VerilatedModule {
  public:
    // CELLS
    Vsig_topology_top_sig_id_translator_rn_snp__pi55* __PVT__i_sig_id_translator_rn_snp;
    Vsig_topology_top_sig_id_translator_rn_req__pi56* __PVT__i_sig_id_translator_rn_req;
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_id_translator_rn_wrapper__pi42(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_id_translator_rn_wrapper__pi42();
    VL_UNCOPYABLE(Vsig_topology_top_sig_id_translator_rn_wrapper__pi42);
