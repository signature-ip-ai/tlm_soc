...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_FIFO_SYNCHCLK_FLOP__PI49_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_FIFO_SYNCHCLK_FLOP__PI49_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_fifo_synchclk_flop__pi49 final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_fifo_synchclk_flop__pi49(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_fifo_synchclk_flop__pi49();
    VL_UNCOPYABLE(Vsig_topology_top_sig_fifo_synchclk_flop__pi49);
