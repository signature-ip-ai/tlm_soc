...
VL_ATTR_COLD void Vsig_topology_top_sig_l3_rx_reqproc_anyvc__pi53___eval_initial__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_l3_porttop_0__sig_l3_porttop_gen_blk__DOT__sig_l3_rxtop_0__sig_l3_rx_reqproc_0__sig_l3_rx_reqproc_vc1(Vsig_topology_top_sig_l3_rx_reqproc_anyvc__pi53* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vsig_topology_top_sig_l3_rx_reqproc_anyvc__pi53___eval_initial__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_l3_porttop_0__sig_l3_porttop_gen_blk__DOT__sig_l3_rxtop_0__sig_l3_rx_reqproc_0__sig_l3_rx_reqproc_vc1\n"); );
    ...
    vlSelfRef.__PVT__mynode_id = 5U;
    vlSelfRef.__PVT__creditfifo_hasroom = 1U;
    vlSelfRef.__PVT__full_credit_fifo = 0U;
}

VL_ATTR_COLD void Vsig_topology_top_sig_l3_rx_reqproc_anyvc__pi53___ctor_var_reset(Vsig_topology_top_sig_l3_rx_reqproc_anyvc__pi53* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vsig_topology_top_sig_l3_rx_reqproc_anyvc__pi53___ctor_var_reset\n"); );
    Vsig_topology_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    VL_SCOPED_RAND_RESET_W(152, vlSelf->__PVT__ic_RX_FLIT, __VscopeHash, 13586822630252626842ull);
    ...
    VL_SCOPED_RAND_RESET_W(152, vlSelf->__PVT__write_data_fifo, __VscopeHash, 11498526385856397901ull);
    VL_SCOPED_RAND_RESET_W(152, vlSelf->__PVT__read_data_fifo, __VscopeHash, 15169263796891844761ull);
    VL_SCOPED_RAND_RESET_W(152, vlSelf->__PVT__read_data_fifo_withbypass, __VscopeHash, 7277652008592496525ull);
    ...
    vlSelf->__PVT__tgt_nodeid_fifoout_up = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 15378981932303803621ull);
    vlSelf->__PVT__req_or_snp_fifoout = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 5491308784000251298ull);
    vlSelf->__PVT__req_or_snp_fifoout_stored = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 8966175152759810892ull);
    vlSelf->__PVT__snp_multicast_fifoout = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 9423853655360874118ull);
    vlSelf->__PVT__snp_multicast_fifoout_stored = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 9275374712320449856ull);
    ...
    vlSelf->__PVT__send_hdr = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 10750348259192415249ull);
    VL_SCOPED_RAND_RESET_W(155, vlSelf->__PVT__flit_out_pl, __VscopeHash, 14866324993249643111ull);
    ...
    VL_SCOPED_RAND_RESET_W(152, vlSelf->__PVT__read_data_fifo_stored, __VscopeHash, 18266271290246763668ull);
    VL_SCOPED_RAND_RESET_W(152, vlSelf->__PVT__read_data_fifo_stored_nxt, __VscopeHash, 9236714825484219837ull);
    vlSelf->__PVT__tgt_clusterid_fifoout_1stcycle = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 6152670674858536479ull);
    vlSelf->__PVT__tgt_portid_fifoout_1stcycle = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 14964557955833531959ull);
    vlSelf->__PVT__tgt_nodeid_fifoout_up_1stcycle = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 5845213822316711916ull);
    vlSelf->__PVT__tgt_clusterid_fifoout_stored = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 8028517996455605483ull);
    vlSelf->__PVT__tgt_portid_fifoout_stored = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 16962071073081204027ull);
    vlSelf->__PVT__tgt_nodeid_fifoout_up_stored = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 15984240809800886119ull);
    vlSelf->__PVT__srcid_bit0_fifoout = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 17885360760144034417ull);
    vlSelf->__PVT__srcid_bit0_fifoout_1stcycle = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 3315110672799586546ull);
    vlSelf->__PVT__srcid_bit0_fifoout_stored = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 12443048615649508137ull);
    ...
    VL_SCOPED_RAND_RESET_W(151, vlSelf->__PVT__read_data_fifo_stored_req_s, __VscopeHash, 1961891673986596303ull);
    VL_SCOPED_RAND_RESET_W(151, vlSelf->__PVT__read_data_fifo_withbypass_req_s, __VscopeHash, 16093643328445255224ull);
    VL_SCOPED_RAND_RESET_W(119, vlSelf->__PVT__read_data_fifo_stored_snp_s, __VscopeHash, 2645147012917079004ull);
    VL_SCOPED_RAND_RESET_W(119, vlSelf->__PVT__read_data_fifo_withbypass_snp_s, __VscopeHash, 2948409248472051575ull);
    ...
    VL_SCOPED_RAND_RESET_W(152, vlSelf->__Vdly__read_data_fifo_stored, __VscopeHash, 2990092295006844582ull);
}
