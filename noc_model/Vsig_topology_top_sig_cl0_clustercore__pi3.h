...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_CL0_CLUSTERCORE__PI3_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_CL0_CLUSTERCORE__PI3_H_  // guard

#include "systemc"
#include "verilated_sc.h"
#include "verilated.h"
class Vsig_topology_top_sig_L3top__pi6;
...
class Vsig_topology_top_sig_coherency_top__pi5;
class Vsig_topology_top_sig_common_porttop__pi4;
class Vsig_topology_top_sig_common_porttop__pi7;
class Vsig_topology_top_sig_node_porttop_wrapper__pi8;
class Vsig_topology_top_sig_node_porttop_wrapper__pi9;


class Vsig_topology_top__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_cl0_clustercore__pi3 final : public VerilatedModule {
  public:
    // CELLS
    ...
    Vsig_topology_top_sig_common_porttop__pi4* __PVT__sig_cc_porttop_0;
    Vsig_topology_top_sig_coherency_top__pi5* __PVT__sig_chi_cc_top_0;
    Vsig_topology_top_sig_L3top__pi6* __PVT__sig_L3top_bypass_0;
    Vsig_topology_top_sig_common_porttop__pi7* __PVT__sig_l3_porttop_0;
    Vsig_topology_top_sig_node_porttop_wrapper__pi8* __PVT__sig_node_porttop_rn_p1;
    Vsig_topology_top_sig_node_porttop_wrapper__pi9* __PVT__sig_node_porttop_sn_p3;
    ...
    struct {
        ...
        CData/*0:0*/ __Vcellinp__sig_node_porttop_rn_p1__i_clear_recovery_interrupt;
        CData/*0:0*/ __Vcellout__sig_node_porttop_rn_p1__o_timeout_recovery_successful;
        CData/*0:0*/ __Vcellout__sig_node_porttop_rn_p1__o_timeout_interrupt;
        CData/*0:0*/ __Vcellinp__sig_node_porttop_rn_p1__i_clear_timeout_interrupt;
        CData/*0:0*/ __Vcellinp__sig_node_porttop_rn_p1__tx_intfrx_gclk;
        CData/*0:0*/ __Vcellinp__sig_node_porttop_rn_p1__rx_intfrx_gclk;
        CData/*0:0*/ __Vcellinp__sig_node_porttop_rn_p1__tx_ic_gclk;
        CData/*0:0*/ __Vcellinp__sig_node_porttop_rn_p1__rx_ic_gclk;
    };
    struct {
        CData/*0:0*/ __Vcellinp__sig_node_porttop_sn_p3__i_clear_recovery_interrupt;
        CData/*0:0*/ __Vcellout__sig_node_porttop_sn_p3__o_timeout_recovery_successful;
        CData/*0:0*/ __Vcellout__sig_node_porttop_sn_p3__o_timeout_interrupt;
        CData/*0:0*/ __Vcellinp__sig_node_porttop_sn_p3__i_clear_timeout_interrupt;
        CData/*0:0*/ __Vcellinp__sig_node_porttop_sn_p3__tx_intfrx_gclk;
        CData/*0:0*/ __Vcellinp__sig_node_porttop_sn_p3__rx_intfrx_gclk;
        CData/*0:0*/ __Vcellinp__sig_node_porttop_sn_p3__tx_ic_gclk;
        CData/*0:0*/ __Vcellinp__sig_node_porttop_sn_p3__rx_ic_gclk;
    ...
    struct {
        ...
        IData/*27:0*/ __PVT__cm_homeaddr_base_all_pm_final;
        IData/*28:0*/ __PVT__cm_homeaddr_limit_all_pm_final;
        IData/*27:0*/ __PVT__noncm_homeaddr_base_all_pm_final;
        IData/*28:0*/ __PVT__noncm_homeaddr_limit_all_pm_final;
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_cl0_clustercore__pi3(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_cl0_clustercore__pi3();
    VL_UNCOPYABLE(Vsig_topology_top_sig_cl0_clustercore__pi3);
