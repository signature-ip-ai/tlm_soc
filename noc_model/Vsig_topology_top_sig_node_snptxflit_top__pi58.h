...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_NODE_SNPTXFLIT_TOP__PI58_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_NODE_SNPTXFLIT_TOP__PI58_H_  // guard

#include "systemc"
#include "verilated_sc.h"
#include "verilated.h"
class Vsig_topology_top_sig_fifo_synchclk_flop__pi66;
...
class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_node_snptxflit_top__pi58 final : public VerilatedModule {
  public:
    // CELLS
    ...
    Vsig_topology_top_sig_fifo_synchclk_flop__pi66* __PVT__sync_fifo_gen__DOT__flit_store_fifo_0;
    Vsig_topology_top_sig_fifo_synchclk_flop__pi67* __PVT__enable_snprsp_generator_in_normal_rn_port__DOT__snpresp_fifo_0;
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_node_snptxflit_top__pi58(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_node_snptxflit_top__pi58();
    VL_UNCOPYABLE(Vsig_topology_top_sig_node_snptxflit_top__pi58);
