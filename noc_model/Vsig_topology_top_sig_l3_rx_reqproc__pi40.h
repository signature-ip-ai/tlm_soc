...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_L3_RX_REQPROC__PI40_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_L3_RX_REQPROC__PI40_H_  // guard

#include "systemc"
#include "verilated_sc.h"
#include "verilated.h"
class Vsig_topology_top_sig_ic_crdt_update__N8;
class Vsig_topology_top_sig_l3_rx_reqproc_anyvc__pi53;


class Vsig_topology_top__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_l3_rx_reqproc__pi40 final : public VerilatedModule {
  public:
    // CELLS
    Vsig_topology_top_sig_l3_rx_reqproc_anyvc__pi53* __PVT__sig_l3_rx_reqproc_vc1;
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_l3_rx_reqproc__pi40(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_l3_rx_reqproc__pi40();
    VL_UNCOPYABLE(Vsig_topology_top_sig_l3_rx_reqproc__pi40);
