...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_NODE_RX_RSPPROC_ANYVC__PI64_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_NODE_RX_RSPPROC_ANYVC__PI64_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_node_rx_rspproc_anyvc__pi64 final : public VerilatedModule {
  public:
    // CELLS
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_node_rx_rspproc_anyvc__pi64(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_node_rx_rspproc_anyvc__pi64();
    VL_UNCOPYABLE(Vsig_topology_top_sig_node_rx_rspproc_anyvc__pi64);
