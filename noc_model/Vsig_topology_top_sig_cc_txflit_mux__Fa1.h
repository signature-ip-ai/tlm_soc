...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_CC_TXFLIT_MUX__FA1_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_CC_TXFLIT_MUX__FA1_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_cc_txflit_mux__Fa1 final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_cc_txflit_mux__Fa1(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_cc_txflit_mux__Fa1();
    VL_UNCOPYABLE(Vsig_topology_top_sig_cc_txflit_mux__Fa1);
