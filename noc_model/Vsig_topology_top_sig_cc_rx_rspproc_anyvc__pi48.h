...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_CC_RX_RSPPROC_ANYVC__PI48_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_CC_RX_RSPPROC_ANYVC__PI48_H_  // guard

#include "systemc"
#include "verilated_sc.h"
#include "verilated.h"
class Vsig_topology_top_sig_fifo_synchclk_flop__pi51;
class Vsig_topology_top_sig_routing_policy;


class Vsig_topology_top__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_cc_rx_rspproc_anyvc__pi48 final : public VerilatedModule {
  public:
    // CELLS
    Vsig_topology_top_sig_fifo_synchclk_flop__pi51* __PVT__flit_store_fifo_0;
    ...
    struct {
        ...
        VlWide<3>/*72:0*/ __PVT__flit_out_pl;
    ...
    struct {
        ...
        VlWide<3>/*72:0*/ __PVT__read_data_fifo_s;
        VlWide<3>/*72:0*/ __PVT__read_data_fifo_stored_s;
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_cc_rx_rspproc_anyvc__pi48(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_cc_rx_rspproc_anyvc__pi48();
    VL_UNCOPYABLE(Vsig_topology_top_sig_cc_rx_rspproc_anyvc__pi48);
