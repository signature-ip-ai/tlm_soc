...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_CC_RX_RSPPROC_ANYVC__PI47_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_CC_RX_RSPPROC_ANYVC__PI47_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_cc_rx_rspproc_anyvc__pi47 final : public VerilatedModule {
  public:
    // CELLS
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_cc_rx_rspproc_anyvc__pi47(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_cc_rx_rspproc_anyvc__pi47();
    VL_UNCOPYABLE(Vsig_topology_top_sig_cc_rx_rspproc_anyvc__pi47);
