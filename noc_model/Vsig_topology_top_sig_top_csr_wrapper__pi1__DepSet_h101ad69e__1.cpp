...
VL_INLINE_OPT void Vsig_topology_top_sig_top_csr_wrapper__pi1___nba_comb__TOP__sig_topology_top__sig_top_csr_wrapper_0__11(Vsig_topology_top_sig_top_csr_wrapper__pi1* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vsig_topology_top_sig_top_csr_wrapper__pi1___nba_comb__TOP__sig_topology_top__sig_top_csr_wrapper_0__11\n"); );
    ...
    vlSelfRef.__PVT__o_cm_homeaddr_limit_all_pm = (0x3ffffffffffffffULL 
                                                   & VL_SEL_QWII(7424, vlSelfRef.__PVT__cm_homeaddr_limit_all_pm, 0U, 58));
}
