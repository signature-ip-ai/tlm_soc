...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_COMMON_PORTTOP__PI7_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_COMMON_PORTTOP__PI7_H_  // guard

#include "systemc"
#include "verilated_sc.h"
#include "verilated.h"
class Vsig_topology_top_sig_l3_rxtop__pi21;
class Vsig_topology_top_sig_l3_txtop__pi22;


class Vsig_topology_top__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_common_porttop__pi7 final : public VerilatedModule {
  public:
    // CELLS
    Vsig_topology_top_sig_l3_rxtop__pi21* __PVT__sig_l3_porttop_gen_blk__DOT__sig_l3_rxtop_0;
    Vsig_topology_top_sig_l3_txtop__pi22* __PVT__sig_l3_porttop_gen_blk__DOT__sig_l3_txtop_0;
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_common_porttop__pi7(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_common_porttop__pi7();
    VL_UNCOPYABLE(Vsig_topology_top_sig_common_porttop__pi7);
