...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_CHI_CRDT_UPDATE_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_CHI_CRDT_UPDATE_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_chi_crdt_update final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_chi_crdt_update(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_chi_crdt_update();
    VL_UNCOPYABLE(Vsig_topology_top_sig_chi_crdt_update);
