...
VL_ATTR_COLD void Vsig_topology_top_sig_node_rx_rspproc_anyvc__pi66___ctor_var_reset(Vsig_topology_top_sig_node_rx_rspproc_anyvc__pi66* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    Vsig_topology_top_sig_node_rx_rspproc_anyvc__pi66___ctor_var_reset\n"); );
    ...
    vlSelf->__PVT__o_rxtop_rspproc_fifo_is_full = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 6175174343036211658ull);
    ...
    vlSelf->__PVT__snpresp_available_sysco_disabled = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 18432423762372010892ull);
    ...
    VL_SCOPED_RAND_RESET_W(73, vlSelf->__PVT__flit_out_pyld, __VscopeHash, 14689513724446069492ull);
    ...
    vlSelf->__PVT__opcode_fifoout = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 872890329951141080ull);
    ...
    VL_SCOPED_RAND_RESET_W(73, vlSelf->__PVT__rddata_snprsp_flit_fifo_tx_snp_s, __VscopeHash, 8060517423761330452ull);
    ...
    VL_SCOPED_RAND_RESET_W(73, vlSelf->__Vcellout__sync_fifo_gen__DOT__flit_store_fifo_0__fifo_rddata, __VscopeHash, 17466365204905324127ull);
    VL_SCOPED_RAND_RESET_W(73, vlSelf->__Vcellinp__sync_fifo_gen__DOT__flit_store_fifo_0__fifo_wrdata, __VscopeHash, 15302313765993236528ull);
