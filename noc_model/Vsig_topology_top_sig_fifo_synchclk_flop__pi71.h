...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_FIFO_SYNCHCLK_FLOP__PI71_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_FIFO_SYNCHCLK_FLOP__PI71_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_fifo_synchclk_flop__pi71 final : public VerilatedModule {
  public:
    ...
    VlUnpacked<VlWide<5>/*150:0*/, 4> __PVT__fifo_loc_nxt;
    VlUnpacked<VlWide<5>/*150:0*/, 4> __PVT__fifo_loc;

    // INTERNAL VARIABLES
    Vsig_topology_top__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vsig_topology_top_sig_fifo_synchclk_flop__pi71(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_fifo_synchclk_flop__pi71();
    VL_UNCOPYABLE(Vsig_topology_top_sig_fifo_synchclk_flop__pi71);
