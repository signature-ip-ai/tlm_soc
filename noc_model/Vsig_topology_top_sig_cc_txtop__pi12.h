...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_CC_TXTOP__PI12_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_CC_TXTOP__PI12_H_  // guard

#include "systemc"
#include "verilated_sc.h"
#include "verilated.h"
class Vsig_topology_top_sig_cc_dattxflit_top__pi33;
class Vsig_topology_top_sig_cc_reqtxflit_top__pi32;
...
class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_cc_txtop__pi12 final : public VerilatedModule {
  public:
    // CELLS
    Vsig_topology_top_sig_cc_reqtxflit_top__pi32* __PVT__sig_cc_reqtxflit_top_0;
    Vsig_topology_top_sig_cc_rsptxflit_top__F3* __PVT__sig_cc_rsptxflit_top_0;
    Vsig_topology_top_sig_cc_dattxflit_top__pi33* __PVT__sig_cc_dattxflit_top_0;
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_cc_txtop__pi12(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_cc_txtop__pi12();
    VL_UNCOPYABLE(Vsig_topology_top_sig_cc_txtop__pi12);
