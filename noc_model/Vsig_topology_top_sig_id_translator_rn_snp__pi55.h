...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_ID_TRANSLATOR_RN_SNP__PI55_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_ID_TRANSLATOR_RN_SNP__PI55_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_id_translator_rn_snp__pi55 final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_id_translator_rn_snp__pi55(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_id_translator_rn_snp__pi55();
    VL_UNCOPYABLE(Vsig_topology_top_sig_id_translator_rn_snp__pi55);
