...
VL_ATTR_COLD void Vsig_topology_top_sig_fifo_synchclk_flop__pi33___stl_sequent__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_chi_cc_top_0__sig_coherency_ctrlr_0__respcmd_fifo_0__0(Vsig_topology_top_sig_fifo_synchclk_flop__pi33* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                      Vsig_topology_top_sig_fifo_synchclk_flop__pi33___stl_sequent__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_chi_cc_top_0__sig_coherency_ctrlr_0__respcmd_fifo_0__0\n"); );
...
VL_ATTR_COLD void Vsig_topology_top_sig_fifo_synchclk_flop__pi33___stl_sequent__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_chi_cc_top_0__sig_coherency_ctrlr_0__respcmd_fifo_0__1(Vsig_topology_top_sig_fifo_synchclk_flop__pi33* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                      Vsig_topology_top_sig_fifo_synchclk_flop__pi33___stl_sequent__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_chi_cc_top_0__sig_coherency_ctrlr_0__respcmd_fifo_0__1\n"); );
    Vsig_topology_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vsig_topology_top_sig_fifo_synchclk_flop__pi33___stl_comb__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_chi_cc_top_0__sig_coherency_ctrlr_0__respcmd_fifo_0__0(Vsig_topology_top_sig_fifo_synchclk_flop__pi33* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                      Vsig_topology_top_sig_fifo_synchclk_flop__pi33___stl_comb__TOP__sig_topology_top__cl0_sig_clustertop__inst_cl0_clustercore__sig_chi_cc_top_0__sig_coherency_ctrlr_0__respcmd_fifo_0__0\n"); );
    Vsig_topology_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
VL_ATTR_COLD void Vsig_topology_top_sig_fifo_synchclk_flop__pi33___ctor_var_reset(Vsig_topology_top_sig_fifo_synchclk_flop__pi33* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                      Vsig_topology_top_sig_fifo_synchclk_flop__pi33___ctor_var_reset\n"); );
    Vsig_topology_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    VL_SCOPED_RAND_RESET_W(74, vlSelf->__PVT__fifo_wrdata, __VscopeHash, 13735560909582501842ull);
    vlSelf->__PVT__fifo_rden = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 13760157769081611964ull);
    VL_SCOPED_RAND_RESET_W(74, vlSelf->__PVT__fifo_rddata, __VscopeHash, 9356019634320357306ull);
    ...
    for (int __Vi0 = 0; __Vi0 < 32; ++__Vi0) {
        VL_SCOPED_RAND_RESET_W(74, vlSelf->__PVT__fifo_loc_nxt[__Vi0], __VscopeHash, 13221930881648868120ull);
    }
    for (int __Vi0 = 0; __Vi0 < 32; ++__Vi0) {
        VL_SCOPED_RAND_RESET_W(74, vlSelf->__PVT__fifo_loc[__Vi0], __VscopeHash, 12988781385847939524ull);
    }
    ...
    VL_SCOPED_RAND_RESET_W(74, vlSelf->__VdlyVal__fifo_loc__v0, __VscopeHash, 13255051178611793530ull);
    vlSelf->__VdlySet__fifo_loc__v0 = 0;
    VL_SCOPED_RAND_RESET_W(74, vlSelf->__VdlyVal__fifo_loc__v1, __VscopeHash, 11885904708264626788ull);
    vlSelf->__VdlySet__fifo_loc__v1 = 0;
    VL_SCOPED_RAND_RESET_W(74, vlSelf->__VdlyVal__fifo_loc__v2, __VscopeHash, 16414715005339778905ull);
    vlSelf->__VdlySet__fifo_loc__v2 = 0;
    VL_SCOPED_RAND_RESET_W(74, vlSelf->__VdlyVal__fifo_loc__v3, __VscopeHash, 13091504067066968602ull);
    vlSelf->__VdlySet__fifo_loc__v3 = 0;
    VL_SCOPED_RAND_RESET_W(74, vlSelf->__VdlyVal__fifo_loc__v4, __VscopeHash, 17888153163750944362ull);
    vlSelf->__VdlySet__fifo_loc__v4 = 0;
    VL_SCOPED_RAND_RESET_W(74, vlSelf->__VdlyVal__fifo_loc__v5, __VscopeHash, 1762205089603743507ull);
    vlSelf->__VdlySet__fifo_loc__v5 = 0;
    VL_SCOPED_RAND_RESET_W(74, vlSelf->__VdlyVal__fifo_loc__v6, __VscopeHash, 7018656539517626646ull);
    vlSelf->__VdlySet__fifo_loc__v6 = 0;
    VL_SCOPED_RAND_RESET_W(74, vlSelf->__VdlyVal__fifo_loc__v7, __VscopeHash, 17724606052206057034ull);
    vlSelf->__VdlySet__fifo_loc__v7 = 0;
    VL_SCOPED_RAND_RESET_W(74, vlSelf->__VdlyVal__fifo_loc__v8, __VscopeHash, 15000717801455077974ull);
    vlSelf->__VdlySet__fifo_loc__v8 = 0;
    VL_SCOPED_RAND_RESET_W(74, vlSelf->__VdlyVal__fifo_loc__v9, __VscopeHash, 13631571331107881384ull);
    vlSelf->__VdlySet__fifo_loc__v9 = 0;
    VL_SCOPED_RAND_RESET_W(74, vlSelf->__VdlyVal__fifo_loc__v10, __VscopeHash, 3798089390520844516ull);
    vlSelf->__VdlySet__fifo_loc__v10 = 0;
    VL_SCOPED_RAND_RESET_W(74, vlSelf->__VdlyVal__fifo_loc__v11, __VscopeHash, 14826111779468860541ull);
    vlSelf->__VdlySet__fifo_loc__v11 = 0;
    VL_SCOPED_RAND_RESET_W(74, vlSelf->__VdlyVal__fifo_loc__v12, __VscopeHash, 1355725619468181139ull);
    vlSelf->__VdlySet__fifo_loc__v12 = 0;
    VL_SCOPED_RAND_RESET_W(74, vlSelf->__VdlyVal__fifo_loc__v13, __VscopeHash, 2305537642393937335ull);
    vlSelf->__VdlySet__fifo_loc__v13 = 0;
    VL_SCOPED_RAND_RESET_W(74, vlSelf->__VdlyVal__fifo_loc__v14, __VscopeHash, 1847716903597710865ull);
    vlSelf->__VdlySet__fifo_loc__v14 = 0;
    VL_SCOPED_RAND_RESET_W(74, vlSelf->__VdlyVal__fifo_loc__v15, __VscopeHash, 16025953050227364059ull);
    vlSelf->__VdlySet__fifo_loc__v15 = 0;
    VL_SCOPED_RAND_RESET_W(74, vlSelf->__VdlyVal__fifo_loc__v16, __VscopeHash, 15180725330309287446ull);
    vlSelf->__VdlySet__fifo_loc__v16 = 0;
    VL_SCOPED_RAND_RESET_W(74, vlSelf->__VdlyVal__fifo_loc__v17, __VscopeHash, 16180012390742856546ull);
    vlSelf->__VdlySet__fifo_loc__v17 = 0;
    VL_SCOPED_RAND_RESET_W(74, vlSelf->__VdlyVal__fifo_loc__v18, __VscopeHash, 510758436235179611ull);
    vlSelf->__VdlySet__fifo_loc__v18 = 0;
    VL_SCOPED_RAND_RESET_W(74, vlSelf->__VdlyVal__fifo_loc__v19, __VscopeHash, 7942174071642545093ull);
    vlSelf->__VdlySet__fifo_loc__v19 = 0;
    VL_SCOPED_RAND_RESET_W(74, vlSelf->__VdlyVal__fifo_loc__v20, __VscopeHash, 3670030020961205877ull);
    vlSelf->__VdlySet__fifo_loc__v20 = 0;
    VL_SCOPED_RAND_RESET_W(74, vlSelf->__VdlyVal__fifo_loc__v21, __VscopeHash, 837003629825695438ull);
    vlSelf->__VdlySet__fifo_loc__v21 = 0;
    VL_SCOPED_RAND_RESET_W(74, vlSelf->__VdlyVal__fifo_loc__v22, __VscopeHash, 2863429904228810512ull);
    vlSelf->__VdlySet__fifo_loc__v22 = 0;
    VL_SCOPED_RAND_RESET_W(74, vlSelf->__VdlyVal__fifo_loc__v23, __VscopeHash, 8694266773200347329ull);
    vlSelf->__VdlySet__fifo_loc__v23 = 0;
    VL_SCOPED_RAND_RESET_W(74, vlSelf->__VdlyVal__fifo_loc__v24, __VscopeHash, 14958795536552752481ull);
    vlSelf->__VdlySet__fifo_loc__v24 = 0;
    VL_SCOPED_RAND_RESET_W(74, vlSelf->__VdlyVal__fifo_loc__v25, __VscopeHash, 1220537916727534992ull);
    vlSelf->__VdlySet__fifo_loc__v25 = 0;
    VL_SCOPED_RAND_RESET_W(74, vlSelf->__VdlyVal__fifo_loc__v26, __VscopeHash, 5643025906530954697ull);
    vlSelf->__VdlySet__fifo_loc__v26 = 0;
    VL_SCOPED_RAND_RESET_W(74, vlSelf->__VdlyVal__fifo_loc__v27, __VscopeHash, 2607713925440384994ull);
    vlSelf->__VdlySet__fifo_loc__v27 = 0;
    VL_SCOPED_RAND_RESET_W(74, vlSelf->__VdlyVal__fifo_loc__v28, __VscopeHash, 13246369552630323827ull);
    vlSelf->__VdlySet__fifo_loc__v28 = 0;
    VL_SCOPED_RAND_RESET_W(74, vlSelf->__VdlyVal__fifo_loc__v29, __VscopeHash, 14316570720551352513ull);
    vlSelf->__VdlySet__fifo_loc__v29 = 0;
    VL_SCOPED_RAND_RESET_W(74, vlSelf->__VdlyVal__fifo_loc__v30, __VscopeHash, 7948091400350062825ull);
    vlSelf->__VdlySet__fifo_loc__v30 = 0;
    VL_SCOPED_RAND_RESET_W(74, vlSelf->__VdlyVal__fifo_loc__v31, __VscopeHash, 5568956195380015654ull);
