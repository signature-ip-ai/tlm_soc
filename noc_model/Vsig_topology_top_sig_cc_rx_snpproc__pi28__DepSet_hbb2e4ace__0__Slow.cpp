...
VL_ATTR_COLD void Vsig_topology_top_sig_cc_rx_snpproc__pi28___ctor_var_reset(Vsig_topology_top_sig_cc_rx_snpproc__pi28* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vsig_topology_top_sig_cc_rx_snpproc__pi28___ctor_var_reset\n"); );
    ...
    vlSelf->__PVT__flit_out_vc0[0] = 0U;
    vlSelf->__PVT__flit_out_vc0[1] = 0U;
    vlSelf->__PVT__flit_out_vc0[2] = 0U;
    vlSelf->__PVT__flit_out_vc0[3] = 0U;
    vlSelf->__PVT__flit_out_vc0[4] = 0U;
    vlSelf->__PVT__flit_out_vc0[5] = 0U;
    VL_SCOPED_RAND_RESET_W(161, vlSelf->__PVT__flit_out_vc1, __VscopeHash, 4252838621045558912ull);
    ...
    vlSelf->__PVT__ic_RX_FLITV_vc0 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 14439074711057118845ull);
    vlSelf->__PVT__ic_RX_FLITV_vc1 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 17460795106935259982ull);
    ...
    VL_SCOPED_RAND_RESET_W(119, vlSelf->__PVT__ic_RX_FLIT_SNPREQ_s, __VscopeHash, 8155662653708698351ull);
