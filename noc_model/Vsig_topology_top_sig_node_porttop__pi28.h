...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_NODE_PORTTOP__PI28_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_NODE_PORTTOP__PI28_H_  // guard
...
class Vsig_topology_top_sig_node_rxtop__pi46;
class Vsig_topology_top_sig_node_txtop__pi45;


class Vsig_topology_top__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_node_porttop__pi28 final : public VerilatedModule {
  public:
    // CELLS
    Vsig_topology_top_sig_node_rxtop__pi46* __PVT__sig_node_rxtop_0;
    Vsig_topology_top_sig_node_txtop__pi45* __PVT__sig_node_txtop_0;
    ...
    struct {
        ...
        CData/*0:0*/ __PVT__id_translator_sn__DOT__tx_req_apply_dmt_from_hn;
        CData/*0:0*/ __PVT__id_translator_sn__DOT__unused_signal;
        CData/*0:0*/ __PVT__id_translator_sn__DOT__unused_signal_nxt;
        CData/*3:0*/ __Vcellinp__id_translator_sn__DOT__sig_id_translator_sn_0__vc1_rx_dat_opcode;
        CData/*0:0*/ __Vcellinp__id_translator_sn__DOT__sig_id_translator_sn_0__vc1_rx_dat_v;
        CData/*3:0*/ __Vcellinp__id_translator_sn__DOT__sig_id_translator_sn_0__vc0_rx_dat_opcode;
        CData/*0:0*/ __Vcellinp__id_translator_sn__DOT__sig_id_translator_sn_0__vc0_rx_dat_v;
        CData/*4:0*/ __Vcellinp__id_translator_sn__DOT__sig_id_translator_sn_0__vc1_rx_rsp_opcode;
        CData/*0:0*/ __Vcellinp__id_translator_sn__DOT__sig_id_translator_sn_0__vc1_rx_rsp_v;
        CData/*4:0*/ __Vcellinp__id_translator_sn__DOT__sig_id_translator_sn_0__vc0_rx_rsp_opcode;
        CData/*0:0*/ __Vcellinp__id_translator_sn__DOT__sig_id_translator_sn_0__vc0_rx_rsp_v;
        CData/*1:0*/ __Vcellinp__id_translator_sn__DOT__sig_id_translator_sn_0__tx_req_order;
        CData/*6:0*/ __Vcellinp__id_translator_sn__DOT__sig_id_translator_sn_0__tx_req_opcode;
        CData/*0:0*/ __PVT__unused_signal_block__DOT__unused_signal_timeout;
        CData/*0:0*/ __Vdly__id_translator_sn__DOT__unused_signal;
        ...
        SData/*11:0*/ __PVT__id_translator_sn__DOT__tx_req_txnid_to_sn;
        SData/*11:0*/ __PVT__id_translator_sn__DOT__tx_req_returntxnid_to_sn;
    };
    struct {
        SData/*11:0*/ __Vcellinp__id_translator_sn__DOT__sig_id_translator_sn_0__vc1_rx_dat_dbid_from_sn;
        SData/*11:0*/ __Vcellinp__id_translator_sn__DOT__sig_id_translator_sn_0__vc1_rx_dat_txnid_from_sn;
        SData/*11:0*/ __Vcellinp__id_translator_sn__DOT__sig_id_translator_sn_0__vc0_rx_dat_dbid_from_sn;
        SData/*11:0*/ __Vcellinp__id_translator_sn__DOT__sig_id_translator_sn_0__vc0_rx_dat_txnid_from_sn;
        SData/*11:0*/ __Vcellinp__id_translator_sn__DOT__sig_id_translator_sn_0__vc1_rx_rsp_txnid_from_sn;
        SData/*11:0*/ __Vcellinp__id_translator_sn__DOT__sig_id_translator_sn_0__vc0_rx_rsp_txnid_from_sn;
        SData/*11:0*/ __Vcellinp__id_translator_sn__DOT__sig_id_translator_sn_0__tx_req_returntxnid_from_hn;
        SData/*11:0*/ __Vcellinp__id_translator_sn__DOT__sig_id_translator_sn_0__tx_req_txnid_from_hn;
    ...
    struct {
        ...
        VlWide<5>/*150:0*/ __PVT__id_translator_sn__DOT__req_flit_to_id_translator;
        VlWide<5>/*150:0*/ __PVT__id_translator_sn__DOT__req_flit_from_id_translator;
        QData/*51:0*/ __PVT__id_translator_sn__DOT__tx_req_addr_to_sn;
        QData/*51:0*/ __Vcellinp__id_translator_sn__DOT__sig_addr_translator_0__i_tx_req_addr;
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_node_porttop__pi28(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_node_porttop__pi28();
    VL_UNCOPYABLE(Vsig_topology_top_sig_node_porttop__pi28);
