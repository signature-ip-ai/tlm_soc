...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_CMN_PIPELINE_CHI__PI23_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_CMN_PIPELINE_CHI__PI23_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_cmn_pipeline_chi__pi23 final : public VerilatedModule {
  public:
    // CELLS
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_cmn_pipeline_chi__pi23(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_cmn_pipeline_chi__pi23();
    VL_UNCOPYABLE(Vsig_topology_top_sig_cmn_pipeline_chi__pi23);
