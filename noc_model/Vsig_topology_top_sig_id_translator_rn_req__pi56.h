...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_ID_TRANSLATOR_RN_REQ__PI56_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_ID_TRANSLATOR_RN_REQ__PI56_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_id_translator_rn_req__pi56 final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        VlWide<30>/*959:0*/ __PVT__id_buffer;
        VlWide<30>/*959:0*/ __PVT__id_buffer_nxt;
        ...
        VlWide<30>/*959:0*/ __Vdly__id_buffer;
    };
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_id_translator_rn_req__pi56(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_id_translator_rn_req__pi56();
    VL_UNCOPYABLE(Vsig_topology_top_sig_id_translator_rn_req__pi56);
