...
VL_ATTR_COLD void Vsig_topology_top_sig_node_rx_reqproc__pi62___ctor_var_reset(Vsig_topology_top_sig_node_rx_reqproc__pi62* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vsig_topology_top_sig_node_rx_reqproc__pi62___ctor_var_reset\n"); );
    ...
    vlSelf->__PVT__cm_addr_match_pm = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 9274994138250664942ull);
    ...
    vlSelf->__PVT__cm_activated_pm = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 7746307622250343239ull);
    for (int __Vi0 = 0; __Vi0 < 4; ++__Vi0) {
    ...
    vlSelf->__PVT__noncm_addr_match_pm = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 448483759362002529ull);
    ...
    vlSelf->__PVT__noncm_activated_pm = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 4947697557670439230ull);
    for (int __Vi0 = 0; __Vi0 < 4; ++__Vi0) {
