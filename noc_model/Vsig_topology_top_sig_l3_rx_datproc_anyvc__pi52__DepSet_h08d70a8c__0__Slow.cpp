...
VL_ATTR_COLD void Vsig_topology_top_sig_l3_rx_datproc_anyvc__pi52___ctor_var_reset(Vsig_topology_top_sig_l3_rx_datproc_anyvc__pi52* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vsig_topology_top_sig_l3_rx_datproc_anyvc__pi52___ctor_var_reset\n"); );
