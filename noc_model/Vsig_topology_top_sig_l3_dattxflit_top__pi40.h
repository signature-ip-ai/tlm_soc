...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_L3_DATTXFLIT_TOP__PI40_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_L3_DATTXFLIT_TOP__PI40_H_  // guard

#include "systemc"
#include "verilated_sc.h"
#include "verilated.h"
class Vsig_topology_top_sig_fifo_synchclk_flop__pi53;
...
class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_l3_dattxflit_top__pi40 final : public VerilatedModule {
  public:
    // CELLS
    ...
    Vsig_topology_top_sig_fifo_synchclk_flop__pi53* __PVT__flit_store_fifo_0;
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_l3_dattxflit_top__pi40(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_l3_dattxflit_top__pi40();
    VL_UNCOPYABLE(Vsig_topology_top_sig_l3_dattxflit_top__pi40);
