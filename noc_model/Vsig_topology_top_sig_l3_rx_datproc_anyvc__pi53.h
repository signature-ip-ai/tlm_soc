...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_L3_RX_DATPROC_ANYVC__PI53_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_L3_RX_DATPROC_ANYVC__PI53_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_l3_rx_datproc_anyvc__pi53 final : public VerilatedModule {
  public:
    // CELLS
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_l3_rx_datproc_anyvc__pi53(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_l3_rx_datproc_anyvc__pi53();
    VL_UNCOPYABLE(Vsig_topology_top_sig_l3_rx_datproc_anyvc__pi53);
