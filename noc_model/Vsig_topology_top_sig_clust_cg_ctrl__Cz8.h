...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_CLUST_CG_CTRL__CZ8_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_CLUST_CG_CTRL__CZ8_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_clust_cg_ctrl__Cz8 final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_clust_cg_ctrl__Cz8(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_clust_cg_ctrl__Cz8();
    VL_UNCOPYABLE(Vsig_topology_top_sig_clust_cg_ctrl__Cz8);
