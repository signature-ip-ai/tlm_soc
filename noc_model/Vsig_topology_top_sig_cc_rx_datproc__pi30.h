...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_CC_RX_DATPROC__PI30_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_CC_RX_DATPROC__PI30_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_cc_rx_datproc__pi30 final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_cc_rx_datproc__pi30(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_cc_rx_datproc__pi30();
    VL_UNCOPYABLE(Vsig_topology_top_sig_cc_rx_datproc__pi30);
