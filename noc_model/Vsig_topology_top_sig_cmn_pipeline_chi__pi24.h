...
#ifndef VERILATED_VSIG_TOPOLOGY_TOP_SIG_CMN_PIPELINE_CHI__PI24_H_
#define VERILATED_VSIG_TOPOLOGY_TOP_SIG_CMN_PIPELINE_CHI__PI24_H_  // guard
...
class Vsig_topology_top_sig_cmn_pipeline_ff__D6f;
class Vsig_topology_top_sig_cmn_pipeline_ff__D9a;


class Vsig_topology_top__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vsig_topology_top_sig_cmn_pipeline_chi__pi24 final : public VerilatedModule {
  public:
    // CELLS
    ...
    Vsig_topology_top_sig_cmn_pipeline_ff__D6f* __PVT__i_pipe_rxsnp_mst;
    ...
    Vsig_topology_top_sig_cmn_pipeline_ff__D2* __PVT__nodeport_configuration__DOT__rn_to_hn_configuration__DOT__i_pipe_sysco;
    Vsig_topology_top_sig_cmn_pipeline_ff__D9a* __PVT__nodeport_configuration__DOT__rn_to_hn_configuration__DOT__i_pipe_rxreq_slv;
    Vsig_topology_top_sig_cmn_pipeline_ff__D4c* __PVT__nodeport_configuration__DOT__rn_to_hn_configuration__DOT__i_pipe_rxrsp_mst;
    ...
    struct {
        ...
        CData/*1:0*/ __Vcellout__nodeport_configuration__DOT__rn_to_hn_configuration__DOT__i_pipe_sysco__data_out;
        CData/*1:0*/ __Vcellinp__nodeport_configuration__DOT__rn_to_hn_configuration__DOT__i_pipe_sysco__data_in;
    ...
    struct {
        ...
        VL_OUTW(__PVT__txsnpflit_slv,107,0,4);
        ...
        VL_INW(__PVT__txsnpflit_mst,107,0,4);
        ...
        VlWide<4>/*110:0*/ __Vcellout__i_pipe_rxsnp_mst__data_out;
        VlWide<4>/*110:0*/ __Vcellinp__i_pipe_rxsnp_mst__data_in;
        VlWide<5>/*153:0*/ __Vcellout__nodeport_configuration__DOT__rn_to_hn_configuration__DOT__i_pipe_rxreq_slv__data_out;
        VlWide<5>/*153:0*/ __Vcellinp__nodeport_configuration__DOT__rn_to_hn_configuration__DOT__i_pipe_rxreq_slv__data_in;
        VlWide<3>/*75:0*/ __Vcellout__nodeport_configuration__DOT__rn_to_hn_configuration__DOT__i_pipe_rxrsp_mst__data_out;
        VlWide<3>/*75:0*/ __Vcellinp__nodeport_configuration__DOT__rn_to_hn_configuration__DOT__i_pipe_rxrsp_mst__data_in;
    };
    ...
    // CONSTRUCTORS
    Vsig_topology_top_sig_cmn_pipeline_chi__pi24(Vsig_topology_top__Syms* symsp, const char* v__name);
    ~Vsig_topology_top_sig_cmn_pipeline_chi__pi24();
    VL_UNCOPYABLE(Vsig_topology_top_sig_cmn_pipeline_chi__pi24);
